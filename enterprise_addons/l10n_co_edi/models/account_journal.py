...
class AccountJournal(models.Model):
    ...
    l10n_co_edi_dian_authorization_number = fields.Char(
        string="Resolución de Facturación"
    )
    l10n_co_edi_dian_authorization_date = fields.Date(string="Fecha de Resolución")
    l10n_co_edi_dian_authorization_end_date = fields.Date(
        string="Fecha de finalización Resolución"
    )
