...
class TestAccountBankStatement(TestAccountBankStatementCommon):
    def test_reconciliation_payment_state(self):
        ...
        test_st_line_1 = self.statement.line_ids.filtered(
            lambda line: line.payment_ref == "line_2"
        )
        test_st_line_2 = self.statement.line_ids.filtered(
        ...
        (test_invoice_1.line_ids + test_payment_1.line_ids).filtered(
        ...
        (test_invoice_1.line_ids + test_payment_2.line_ids).filtered(
            lambda line: line.account_id.user_type_id.type == "receivable"
        ).reconcile()
        ...
        counterpart_line = test_payment_1.line_ids.filtered(
            lambda line: line.account_id.user_type_id.type != "receivable"
        )
        ...
        counterpart_line = test_payment_2.line_ids.filtered(
            lambda line: line.account_id.user_type_id.type != "receivable"
        )
        ...
        (test_invoice_2.line_ids + test_payment_2.line_ids).filtered(
            lambda line: line.account_id.user_type_id.type == "receivable"
        ).reconcile()
        ...
        (test_invoice_2.line_ids + test_st_line_2.line_ids).filtered(
            lambda line: line.account_id.user_type_id.type == "receivable"
        ).reconcile()
