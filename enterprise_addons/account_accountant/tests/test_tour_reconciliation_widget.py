...
class TestTourReconciliationWidget(AccountTestInvoicingHttpCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        (
            cls.out_invoice_1 + cls.out_invoice_2 + cls.in_invoice_1 + cls.in_invoice_2
        ).action_post()
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            ...
                            "amount": 350.0,
                            "partner_id": cls.partner_a.id,
                            "payment_ref": "line1: Payment of %s and %s"
                            % (cls.out_invoice_1.name, cls.out_invoice_2.name),
                        },
                    ),
    ...
    def test_bank_statement_reconciliation_tour(self):
        ...
        account_reconcile_model = self.env["account.reconcile.model"].search(
