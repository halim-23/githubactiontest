  ...
  Tour.register(
    ...
    [
      ...
      },
      {
        ...
        trigger:
          '.o_reconciliation_line:nth-child(1) .accounting_view .line_amount:contains("500.00")',
      },
      {
      ...
      },
      {
        ...
        trigger:
          '.o_reconciliation_line:nth-child(1) .o_field_many2one[name="partner_id"] input',
        run: "text partner_b",
      },
      {
      ...
      },
      {
        ...
        extra_trigger:
          '.o_reconciliation_line:nth-child(1) .match .cell_label:contains("BILL"):not(:contains("partner_b"))',
      ...
      },
      {
        ...
        trigger:
          '.o_reconciliation_line:nth-child(1) .o_notebook .cell_left:contains("180.00")',
      },
      {
...

      {
        ...
        extra_trigger:
          '.o_reconciliation_line:nth-child(1) .cell_label:contains("line4")',
        trigger:
          '.o_reconciliation_line:nth-child(1) .o_notebook .nav-link[href*="notebook_page_create"]',
      },
      {
        content: "Enter the write-off account",
        trigger:
          '.o_reconciliation_line:nth-child(1) .o_field_many2one[name="account_id"] input',
        run: "text 151000",
      },
      {
