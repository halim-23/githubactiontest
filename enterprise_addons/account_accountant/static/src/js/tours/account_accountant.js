odoo.define("account_accountant.tour", function (require) {
  ...
  tour.tours.account_tour.steps.splice(
    0,
    3,
    ..._.map(
    ...
    {
      trigger:
        '.dropdown-item[data-menu-xmlid="account.menu_action_move_out_invoice_type"]',
      content: _t("Go to invoicing"),
      auto: true,
    }
  );
  ...
  tour.register(
    ...
    [
      ...tour.stepUtils.goToAppSteps(
        "account_accountant.menu_accounting",
        _t("Let’s automate your bills, bank transactions and accounting processes.")
      ),
      ...
      },
      {
        trigger: ".o_data_cell",
        extra_trigger:
          'tr:not(.o_sample_data_disabled)>td:has(span[name="payment_state"])',
      ...
      },
      {
        ...
        content: _t(
          "Check & validate the bill. If no vendor has been found, add one before validating."
        ),
        position: "bottom",
      },
      {
      ...
      {
        trigger:
          'a[data-method="setting_init_bank_account_action"].o_onboarding_step_action',
  ...
  tour.register(
    "account_accountant_tour_upload_ocr_step",
    {
      rainbowMan: false,
      sequence: 70,
    },
    [
      {
        ...
        content: Markup(
          _t(
            "Let’s use AI to fill in the form<br/><br/><i>Tip: If the OCR is not done yet, wait a few more seconds and try again.</i>"
          )
        ),
        position: "bottom",
      },
