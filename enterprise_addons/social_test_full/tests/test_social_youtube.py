...
class SocialYoutube(SocialTestFullCase):
    def test_youtube_link(self):
        ...
        with patch.object(
            SocialLivePostFacebook, "_post_facebook", lambda *args, **kwargs: None
        ), patch.object(
            SocialLivePostTwitter, "_post_twitter", lambda *args, **kwargs: None
        ), patch.object(
            SocialLivePostLinkedin, "_post_linkedin", lambda *args, **kwargs: None
        ), patch.object(
            SocialLivePostYoutube, "_post_youtube", lambda *args, **kwargs: None
        ):
        ...
        self.assertEqual(
            ...
            social_post.push_notification_target_url,
        )
