  ...
  _openPlanDialog: function (context) {
    ...
    Object.assign(context, {
      ...
      search_default_sale_order_id:
        this.model.context.planning_gantt_active_sale_order_id || null,
    });
    ...
    this._rpc({
      ...
      if (result) {
        ...
        notificationOptions = {
          type: "danger",
          message: _t(
            "There are no sales orders to assign or no employees are available."
          ),
        };
      }
