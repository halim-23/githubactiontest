...
from odoo.addons.account_reports.tests.test_general_ledger_report import (
...
class AccountXmlPolizasWizard(TestAccountReportsCommon):
                    ...
                    "line_ids": [
                        (
                            ...
                            0,
                            {
                                ...
                                "credit": 0.0,
                                "name": "2016_1_1",
                                "account_id": cls._get_id("account_payable"),
                            },
                        ),
                        (
                            0,
                            0,
                            {
                                ...
                                "credit": 0.0,
                                "name": "2016_1_2",
                                "account_id": cls._get_id("account_expense"),
                            },
                        ),
                        (
                            0,
                            0,
                            {
                                ...
                                "credit": 300.0,
                                "name": "2016_1_3",
                                "account_id": cls._get_id("account_revenue"),
                            },
                        ),
                    ],
                },
                    ...
                    "line_ids": [
                        (
                            ...
                            0,
                            {
                                ...
                                "credit": 0.0,
                                "name": "2017_1_1",
                                "account_id": cls._get_id("account_receivable"),
                            },
                        ),
                        (
                            0,
                    ...
                    "line_ids": [
                        (
                            ...
                            0,
                            {
                                ...
                                "credit": 0.0,
                                "name": "2016_2_1",
                                "account_id": cls._get_id("account_payable", 2),
                            },
                        ),
                        (
                            0,
                            0,
                            {
                                ...
                                "credit": 100.0,
                                "name": "2016_2_2",
                                "account_id": cls._get_id("account_revenue", 2),
                            },
                        ),
                    ],
                },
                    ...
                    "line_ids": [
                        (
                            ...
                            0,
                            {
                                ...
                                "credit": 0.0,
                                "name": "2017_2_1",
                                "account_id": cls._get_id("account_expense", 2),
                            },
                        ),
                        (
                            0,
    ...
    def _get_xml_data(self, date_from, date_to, company=None):
        ...
        options = self._init_options(
            self.env["account.general.ledger"], date_from, date_to
        )
    ...
    def test_xml_polizas_simple(self):
        ...
        self._assert_export_equal(
            year=2017,
            month=1,
            filename="AAAA611013AAA201701PL.XML",
            expected_xml=expected_xml,
            actual_data=exported_file,
        )
    ...
    def test_xml_polizas_multicompany(self):
        ...
        self._assert_export_equal(
            year=2016,
            month=1,
            filename="AAAA611013AAA201601PL.XML",
            expected_xml=expected_xml,
            actual_data=exported_file,
        )
        ...
        exported_file = self._get_xml_data(date_from, date_to, company=self.company_2)[
            0
        ]
        self._assert_export_equal(
            year=2016,
            month=1,
            filename="P&G851223B24201601PL.XML",
            expected_xml=expected_xml,
            actual_data=exported_file,
        )
    ...
    def test_xml_polizas_split_by_date(self):
        ...
        exported_jan_file = next(
            (x for x in exported_files if x["filename"] == jan_filename), None
        )
        self.assertIsNotNone(exported_jan_file)
        self._assert_export_equal(
            year=2016,
            month=1,
            filename=jan_filename,
            expected_xml=expected_xml_jan,
            actual_data=exported_jan_file,
        )
        ...
        exported_jun_file = next(
            (x for x in exported_files if x["filename"] == jun_filename), None
        )
        self.assertIsNotNone(exported_jun_file)
        self._assert_export_equal(
            year=2016,
            month=6,
            filename=jun_filename,
            expected_xml=expected_xml_jun,
            actual_data=exported_jun_file,
        )
