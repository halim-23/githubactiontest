    ...
    [
      {
        ...
        content: Markup(
          _t(
            "Ready to <b>manage your onsite interventions</b>? <i>Click Field Service to start.</i>"
          )
        ),
        position: "bottom",
      },
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "Add a <b>title</b> <i>(e.g. Boiler maintenance, Air-conditioning installation, etc.).</i>"
          )
        ),
        position: "right",
        width: 200,
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "Confirm the <b>time spent</b> on your task. <i>Tip: a rounding of 15min has automatically been applied.</i>"
          )
        ),
        position: "bottom",
      ...
      },
      {
        ...
        extra_trigger: ".o_form_project_tasks",
        content: _t(
          "Let's <b>mark your task as done!</b> <i>Tip: when doing so, your stock will automatically be updated, and your task will move to the next stage.</i>"
        ),
        position: "bottom",
