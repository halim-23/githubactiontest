...
class TestTaskDependencies(TestProjectCommon):
    ...
    def test_task_dependencies_settings_change(self):
        ...
        self.assertFalse(
            ...
            "FSM Projects should not follow group_project_task_dependencies setting changes",
        )
        ...
        with Form(self.env["project.project"]) as project_form:
            ...
            self.assertFalse(
                project_form.allow_task_dependencies,
                "New FSM Projects allow_task_dependencies should default False",
            )
