...
QUnit.module("voip", {}, function () {
  QUnit.module("components", {}, function () {
    QUnit.module("activity", {}, function () {
      ...
      QUnit.test("activity: rendering - only with mobile number", async function (
        assert
      ) {
        assert.expect(5);
      ...
      QUnit.test("activity: rendering - only with phone number", async function (
        assert
      ) {
        assert.expect(5);
        ...
        assert.containsOnce(document.body, ".o_Activity_voipNumberPhone");
        assert.containsOnce(
      ...
      QUnit.test(
        "activity: rendering - with both mobile and phone number",
