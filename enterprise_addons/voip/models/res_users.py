...
class ResUsers(models.Model):
    ...
    sip_always_transfer = fields.Boolean(
        "Always Redirect to Handset", default=False, groups="base.group_user"
    )
    sip_ignore_incoming = fields.Boolean(
        "Reject All Incoming Calls", default=False, groups="base.group_user"
    )
    ...
    def reset_last_seen_phone_call(self):
        ...
        last_call = self.env["voip.phonecall"].search(
