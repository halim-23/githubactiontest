...
class MailActivity(models.Model):
        ...
        for activity in activities:
            if activity.activity_type_id.category == "phonecall":
                ...
                if numbers["phone"] or numbers["mobile"]:
                    ...
                    phonecall = self.env["voip.phonecall"].create_from_activity(
                        activity
                    )
    ...
    def write(self, values):
        if "date_deadline" in values:
            self.mapped("voip_phonecall_id").write(
    ...
    def _action_done(self, feedback=False, attachment_ids=None):
        ...
        phonecall_values_to_keep = (
            {}
        )  # mapping index of self and acitivty value to keep {index: {key1: value1, key2: value2}}
