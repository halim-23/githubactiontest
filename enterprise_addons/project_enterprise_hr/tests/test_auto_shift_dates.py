...
class TestTaskDependencies(AutoShiftDatesHRCommon):
    def test_auto_shift_employee_integration(self):
        ...
        new_task_3_begin_date = self.task_1_planned_date_end - timedelta(
            hours=2
        )  # 2021 06 24 10:00
        self.task_3.write(
            {
        ...
        self.assertEqual(
            ...
            new_task_3_begin_date - relativedelta(days=1, hour=14),
            failed_message,
        )
        ...
        new_task_3_begin_date = self.task_1.planned_date_begin + relativedelta(
            hour=10
        )  # 2021 06 23 10:00
        self.task_3.write(
            {
        ...
        self.assertEqual(
            self.task_1.planned_date_begin,
            new_task_3_begin_date + relativedelta(days=-1, hour=11),
            failed_message,
        )
        failed_message = "The auto shift date feature should take the company's calendar into account before employee create_date."
        new_task_3_begin_date = self.armande_employee_create_date - relativedelta(
            days=3, hour=9
        )
        self.task_3.write(
            {
        ...
        self.assertEqual(
            self.task_1.planned_date_begin,
            new_task_3_begin_date - relativedelta(days=1, hour=15),
            failed_message,
        )
        new_task_1_begin_date = self.armande_departure_date + relativedelta(
            days=1, hour=11
        )
        self.task_1.write(
            {
                "planned_date_begin": new_task_1_begin_date,
                "planned_date_end": new_task_1_begin_date
                + (self.task_1_planned_date_end - self.task_1_planned_date_begin),
            }
        )
        self.assertEqual(
            self.task_3.planned_date_begin,
            new_task_1_begin_date + relativedelta(hour=14),
            failed_message,
        )
        ...
        self.assertEqual(
            self.task_1.planned_date_begin,
            new_task_3_begin_date + relativedelta(hour=9),
            failed_message,
        )
        new_task_1_begin_date = self.armande_departure_date - relativedelta(
            days=1, hour=16
        ...
        self.assertEqual(
            self.task_3.planned_date_begin,
            new_task_1_begin_date + relativedelta(days=1, hour=13),
            failed_message,
        )
        ...
        self.assertEqual(
            self.task_1.planned_date_begin,
            new_task_3_begin_date + relativedelta(hour=11),
            failed_message,
        )
        self.armande_employee.write(
            {
        ...
        self.assertEqual(
            ...
            new_task_1_begin_date + relativedelta(days=1, hour=9),
            failed_message,
        )
