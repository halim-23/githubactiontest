...
class AccountFinancialReportXMLReportExport(models.TransientModel):
    ...
    calling_export_wizard_id = fields.Many2one(
        ...
        help="Optional field containing the report export wizard calling this wizard, if there is one.",
    )
    ...
    def print_xml(self):
        if (
            ...
            and not self.calling_export_wizard_id.l10n_be_reports_periodic_vat_wizard_id
        ):
