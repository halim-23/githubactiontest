...
class ECSalesReport(models.AbstractModel):
    ...
    def _get_ec_sale_code_options_data(self, options):
        ...
        return {
            "goods": {
                "name": "L (46L)",
                "tax_report_line_ids": self.env.ref("l10n_be.tax_report_line_46L").ids
                + self.env.ref("l10n_be.tax_report_line_48s46L").ids,
                "code": "L",
            },
            "triangular": {
                "name": "T (46T)",
                "tax_report_line_ids": self.env.ref("l10n_be.tax_report_line_46T").ids
                + self.env.ref("l10n_be.tax_report_line_48s46T").ids,
                "code": "T",
            },
            "services": {
                "name": "S (44)",
                "tax_report_line_ids": self.env.ref("l10n_be.tax_report_line_44").ids
