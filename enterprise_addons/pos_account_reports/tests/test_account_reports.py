...
class POSTestTaxReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company_data[
            "company"
        ].chart_template_id.country_id = test_country  # So that we can easily instantiate test tax templates within this country
        ...
        cls.pos_tax_report_line_invoice_base = cls._create_tax_report_line(
            "Invoice Base", tax_report, tag_name="pos_invoice_base", sequence=0
        )
        cls.pos_tax_report_line_invoice_tax = cls._create_tax_report_line(
            "Invoice Tax", tax_report, tag_name="pos_invoice_tax", sequence=1
        )
        cls.pos_tax_report_line_refund_base = cls._create_tax_report_line(
            "Refund Base", tax_report, tag_name="pos_refund_base", sequence=2
        )
        cls.pos_tax_report_line_refund_tax = cls._create_tax_report_line(
            "Refund Tax", tax_report, tag_name="pos_refund_tax", sequence=3
        )
                    ...
                    (
                        ...
                        0,
                        {
                            ...
                            "plus_report_line_ids": [
                                cls.pos_tax_report_line_invoice_base.id
                            ],
                        },
                    ),
                    (
                        ...
                        0,
                        {
                            ...
                            "plus_report_line_ids": [
                                cls.pos_tax_report_line_invoice_tax.id
                            ],
                        },
                    ),
                ],
                "refund_repartition_line_ids": [
                    (
                        ...
                        0,
                        {
                            ...
                            "repartition_type": "base",
                            "plus_report_line_ids": [
                                cls.pos_tax_report_line_refund_base.id
                            ],
                        },
                    ),
                    (
                        ...
                        0,
                        {
                            ...
                            "repartition_type": "tax",
                            "plus_report_line_ids": [
                                cls.pos_tax_report_line_refund_tax.id
                            ],
                        },
                    ),
                ],
        ...
        cls.pos_tax = tax_template._generate_tax(cls.company_data["company"])[
            "tax_template_to_tax"
        ][tax_template]
