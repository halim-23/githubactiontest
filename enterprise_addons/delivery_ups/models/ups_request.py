...
UPS_ERROR_MAP = {
    ...
    "128089": _lt(
        "Access License number is Invalid. Provide a valid number (Length should be 0-35 alphanumeric characters)"
    ),
    "190001": _lt(
...
class Package:
    def __init__(self, carrier, weight, quant_pack=False, name=""):
        ...
        if quant_pack:
            self.dimension = {
                "length": quant_pack.packaging_length,
                "width": quant_pack.width,
                "height": quant_pack.height,
            }
        else:
            self.dimension = {
                "length": carrier.ups_default_package_type_id.packaging_length,
                "width": carrier.ups_default_package_type_id.width,
                "height": carrier.ups_default_package_type_id.height,
            }
