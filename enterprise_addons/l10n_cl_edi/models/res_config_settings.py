...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_cl_dte_email = fields.Char(
        "DTE Email", related="company_id.l10n_cl_dte_email", readonly=False
    )
    l10n_cl_dte_service_provider = fields.Selection(
        related="company_id.l10n_cl_dte_service_provider",
        readonly=False,
    ...
    l10n_cl_dte_resolution_number = fields.Char(
        ...
        related="company_id.l10n_cl_dte_resolution_number",
        readonly=False,
    ...
    l10n_cl_dte_resolution_date = fields.Date(
        ...
        related="company_id.l10n_cl_dte_resolution_date",
        readonly=False,
    )
    l10n_cl_sii_regional_office = fields.Selection(
        related="company_id.l10n_cl_sii_regional_office",
        readonly=False,
        translate=False,
    ...
    l10n_cl_company_activity_ids = fields.Many2many(
        ...
        related="company_id.l10n_cl_company_activity_ids",
        readonly=False,
    ...
    l10n_cl_sii_taxpayer_type = fields.Selection(
        related="company_id.l10n_cl_sii_taxpayer_type",
        readonly=False,
