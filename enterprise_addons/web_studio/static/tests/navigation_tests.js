...
QUnit.module("Studio", (hooks) => {
  ...
  QUnit.test("open Studio with act_window", async function (assert) {
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_app[data-menu-xmlid=app_1]")
    );
  ...
  QUnit.test("open Studio with act_window and viewType", async function (assert) {
    ...
    await testUtils.dom.click(
      $(webClient.el).find(
        '.o_menu_sections .o_nav_entry:contains("Partners (Action 3)")'
      )
    );
    await legacyExtraNextTick();
  ...
  QUnit.test("navigation in Studio with act_window", async function (assert) {
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_studio_navbar .o_menu_toggle")
    );
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_app[data-menu-xmlid=app_2]")
    );
    await legacyExtraNextTick();
  ...
  QUnit.test("open Studio with non editable view", async function (assert) {
    ...
    await testUtils.dom.click(
      webClient.el.querySelector(".o_app[data-menu-xmlid=app_9]")
    );
    await legacyExtraNextTick();
  ...
  QUnit.test(
    ...
    async function (assert) {
      ...
      await testUtils.dom.click(
        webClient.el.querySelector(".o_app[data-menu-xmlid=app_43]")
      );
      await legacyExtraNextTick();
