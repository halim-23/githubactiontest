odoo.define("web_studio.testUtils", function (require) {
  ...
  async function createReportEditor(params) {
    ...
    return parent.appendTo(selector).then(function () {
      ...
      return editor
        .appendTo(parent.$(".o_web_studio_editor_manager"))
        .then(function () {
          return editor;
        });
    });
   ...
   *
   * @param {Object} params
   * @returns {Promise<ReportEditorManager>}
   */
   ...
   *
   * @param {Object} params
   * @returns {Promise<ReportEditorSidebar>}
   */
