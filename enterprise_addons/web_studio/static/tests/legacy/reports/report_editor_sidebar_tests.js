      ...
      function () {
        QUnit.test("basic rendering", async function (assert) {
          ...
          studioTestUtils
            ...
            .then(async function (sidebar) {
              assert.hasClass(
                sidebar.$('.o_web_studio_sidebar_header [name="report"]'),
                "active",
                "the report tab should be active"
              );
              assert.hasClass(
                sidebar.$('.o_web_studio_sidebar_header [name="options"]'),
                "inactive",
              ...
              testUtils.dom.click(
                sidebar.$('.o_web_studio_sidebar_header [name="new"]')
              );
        ...
        QUnit.test("'Report' tab behaviour", async function (assert) {
          ...
          return studioTestUtils
            ...
            .then(async function (sidebar) {
              assert.hasAttrValue(
                sidebar.$(".o_web_studio_sidebar_header > .active"),
                "name",
                "report",
                "the 'Report' tab should be active"
              );
              assert.strictEqual(
                sidebar.$('input[name="name"]').val(),
                "Kikou",
              ...
              sidebar
                .$('[name="paperformat_id"] input')
                .val("")
                .trigger("keyup")
                .trigger("focusout");
              await testUtils.nextTick();
              assert.deepEqual(paperformatValues, [
                {paperformat_id: 42},
        ...
        QUnit.test("basic 'Options' tab behaviour", function (assert) {
          ...
          studioTestUtils
            ...
            .then(function (sidebar) {
              ...
              assert.containsOnce(
                sidebar,
                ".o_web_studio_sidebar_content .collapse",
                "there should be one node in the accordion"
              );
              assert.hasClass(
                sidebar.$(".o_web_studio_sidebar_content .collapse"),
                "show",
              ...
              testUtils.dom.click(
                sidebar.$(
                  ".o_web_studio_sidebar_content .collapse .o_web_studio_remove"
                )
              );
        ...
        QUnit.test("'Options' tab with multiple nodes", function (assert) {
          ...
          studioTestUtils
            ...
            .then(function (sidebar) {
              ...
              assert.containsN(
                sidebar,
                ".o_web_studio_sidebar_content .card",
                2,
                "there should be one node in the accordion"
              );
              assert.hasClass(
                sidebar.$(
                  ".o_web_studio_sidebar_content .card:has(.o_text:contains(span)) .collapse"
                ),
                "show",
              ...
              assert.doesNotHaveClass(
                sidebar.$(
                  ".o_web_studio_sidebar_content .card:has(.o_text:contains(div)) .collapse"
                ),
                "show",
              ...
              assert.strictEqual(
                sidebar
                  .$(
                    ".o_web_studio_sidebar_content .o_web_studio_accordion > .card:last .card-header:first"
                  )
                  .text()
                  .trim(),
                "span",
              ...
              testUtils.dom.click(
                sidebar.$(
                  '.o_web_studio_sidebar_content .o_web_studio_accordion > .card:first [data-toggle="collapse"]:first'
                )
              );
              ...
              setTimeout(function () {
                assert.doesNotHaveClass(
                  sidebar.$(
                    ".o_web_studio_sidebar_content .card:has(.o_text:contains(span)) .collapse:first"
                  ),
                  "show",
                ...
                assert.hasClass(
                  sidebar.$(
                    ".o_web_studio_sidebar_content .card:has(.o_text:contains(div)) .collapse:first"
                  ),
                  "show",
                ...
                testUtils.dom.click(
                  sidebar.$(
                    '.o_web_studio_sidebar_content .o_web_studio_accordion > .card:last [data-toggle="collapse"]:first'
                  )
                );
                setTimeout(function () {
                  assert.hasClass(
        ...
        QUnit.test("'Options' tab with layout component can be expanded", function (
          assert
        ) {
          var done = assert.async();
          assert.expect(3);
          ...
          studioTestUtils
            ...
            .then(function (sidebar) {
              ...
              assert.containsOnce(
                sidebar,
                ".o_web_studio_sidebar_content .o_web_studio_layout",
                "there should be a layout component"
              );
              assert.containsOnce(
                sidebar,
                ".o_web_studio_sidebar_content .o_web_studio_layout .o_web_studio_margin",
        ...
        QUnit.test(
          "'Options' tab with layout component can be expanded on open ",
          function (assert) {
            var done = assert.async();
            assert.expect(1);
        ...
        QUnit.test(
          "'Options' tab with layout component can be expanded on open with hierarchy",
          function (assert) {
            var done = assert.async();
            assert.expect(2);
              ...
              .then(function (sidebar) {
                ...
                assert.equal(
                  sidebar
                    ...
                    .join(" > "),
                  't > t [foreach="5"] > t > div > span [rec]',
                  "Should have all ordered parents"
                );
        ...
        QUnit.test(
          "'Options' tab with widget selection (tOptions) component",
          function (assert) {
            var done = assert.async();
            assert.expect(4);
            ...
            studioTestUtils
              ...
              .then(function (sidebar) {
                assert.containsOnce(
                  sidebar,
                  ".o_web_studio_tfield_fieldexpression",
                  "the t-field component should be displayed"
                );
                assert.containsOnce(
                  sidebar,
                  ".o_web_studio_toption_widget",
                  "the t-options component should be displayed"
                );
                assert.strictEqual(
                  sidebar
                    .$(".o_web_studio_toption_widget select")
                    .text()
                    .replace(/\s/g, ""),
                  "imageintegertext",
                ...
                assert.strictEqual(
                  sidebar.$(".o_web_studio_toption_widget select").val(),
                  "text",
        ...
        QUnit.test("'Options' tab with FieldSelector does not flicker", async function (
          assert
        ) {
          assert.expect(3);
          ...
          await testUtils.nextTick();
          assert.strictEqual(
            $(".o_web_studio_tfield_fieldexpression").length,
            0,
          ...
          assert.strictEqual(
            sidebar
              .$(".o_web_studio_tfield_fieldexpression .o_field_selector_value")
              .text()
              .replace(/\s/g, ""),
            "doc(MyModel)ID",
        ...
        QUnit.test("Various layout changes", function (assert) {
          ...
          var nodeWithAllLayoutPropertiesSet = {
            ...
            attrs: {
              // Width: "1",
              style:
                "margin-top:2px;width:1px;margin-right:3px;margin-bottom:4px;margin-left:5px;",
          ...
          var nodeWithAllLayoutPropertiesFontAndBackgroundSet = {
            ...
            attrs: {
              // Width: "1",
              style:
                "margin-top:2px;margin-right:3px;width:1px;margin-bottom:4px;margin-left:5px;background-color:#00FF00;color:#00FF00",
          ...
          var layoutChangesOperations = [
            {
              ...
              sidebarOperationInputSelector:
                '.o_web_studio_margin [data-margin="margin-top"]',
              valueToPut: "42",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="margin-top:42px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "change",
              sidebarOperationInputSelector:
                '.o_web_studio_margin [data-margin="margin-bottom"]',
              valueToPut: "42",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="margin-bottom:42px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "change",
              sidebarOperationInputSelector:
                '.o_web_studio_margin [data-margin="margin-left"]',
              valueToPut: "42",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="margin-left:42px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "change",
              sidebarOperationInputSelector:
                '.o_web_studio_margin [data-margin="margin-right"]',
              valueToPut: "42",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="margin-right:42px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="width:42px;display:inline-block"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/span",
                  },
            ...
            },
            {
              ...
              sidebarOperationInputSelector:
                '.o_web_studio_font_size .dropdown-item-text[data-value="h3"]',
              expectedRPC: {
                inheritance: [
                  {
            ...
            },
            {
              ...
              sidebarOperationInputSelector:
                '.o_web_studio_colors .o_web_studio_background_colorpicker button[data-color="o-color-3"]',
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="class" separator=" " add="bg-o-color-3"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "mousedown",
              sidebarOperationInputSelector:
                '.o_web_studio_colors .o_web_studio_background_colorpicker button[data-value="#00FF00"]',
              valueToPut: "h3",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="background-color:#00FF00"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "mousedown",
              sidebarOperationInputSelector:
                '.o_web_studio_colors .o_web_studio_font_colorpicker button[data-color="o-color-3"]',
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="class" separator=" " add="text-o-color-3"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "mousedown",
              sidebarOperationInputSelector:
                '.o_web_studio_colors .o_web_studio_font_colorpicker button[data-value="#00FF00"]',
              valueToPut: "h3",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" add="color:#00FF00"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "click",
              sidebarOperationInputSelector:
                '.o_web_studio_text_alignment button[title="right"]',
              expectedRPC: {
                inheritance: [
                  {
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="margin-top:2px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="margin-bottom:4px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="margin-left:5px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="margin-right:3px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="width:1px"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "click",
              sidebarOperationInputSelector:
                ".o_web_studio_colors .o_web_studio_background_colorpicker .o_web_studio_reset_color",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="class" separator=" " remove="bg-o-color-3"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="background-color:#00FF00"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "click",
              sidebarOperationInputSelector:
                ".o_web_studio_colors .o_web_studio_font_colorpicker .o_web_studio_reset_color",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="class" separator=" " remove="text-o-color-2"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            },
            {
              ...
              eventToTrigger: "click",
              sidebarOperationInputSelector:
                ".o_web_studio_colors .o_web_studio_font_colorpicker button.o_web_studio_reset_color",
              expectedRPC: {
                inheritance: [
                  {
                    content:
                      '<attribute name="style" separator=";" remove="color:#00FF00"/>',
                    position: "attributes",
                    view_id: 99,
                    xpath: "/t/t/div",
                  },
            ...
            studioTestUtils
              ...
              .then(function (sidebar) {
                testUtils.mock.intercept(sidebar, "view_change", function (ev) {
                  assert.deepEqual(
                    ev.data.operation,
                    changeOperation.expectedRPC,
                    changeOperation.testName
                  );
                });
                sidebar
                  .$(changeOperation.sidebarOperationInputSelector)
