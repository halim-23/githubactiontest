...
QUnit.module("Studio", (hooks) => {
  ...
  QUnit.test("app creator: standard flow with model creation", async function (assert) {
    ...
    await testUtils.dom.click(
      appCreator.el.getElementsByClassName("o_web_studio_selector")[0]
    );
    ...
    await testUtils.dom.click(
      appCreator.el.querySelectorAll(
        ".o_web_studio_selectors > .o_web_studio_selector"
      )[0]
    );
    await testUtils.dom.click(
      appCreator.el.querySelectorAll(
    ...
    await testUtils.dom.click(
      appCreator.el.querySelectorAll(".o_web_studio_palette div")[2]
    );
    await testUtils.dom.click(
      appCreator.el.querySelectorAll(
        ".o_web_studio_selectors > .o_web_studio_selector"
    ...
    const appNameInput = appCreator.el.querySelector('input[name="appName"]')
      .parentNode;
  ...
  QUnit.test(
    "app creator: has 'lines' options to auto-create a one2many",
    async function (assert) {
      ...
      await testUtils.fields.editInput(
        appCreator.el.querySelector("input[id='appName']"),
        "testApp"
      );
      await testUtils.dom.click(
        appCreator.el.querySelector(".o_web_studio_app_creator_next")
      ...
      await testUtils.fields.editInput(
        appCreator.el.querySelector("input[id='menuName']"),
        "testMenu"
      );
      await testUtils.dom.click(
        appCreator.el.querySelector(".o_web_studio_app_creator_next")
  ...
  QUnit.test("app creator: debug flow with existing model", async function (assert) {
    ...
    let buttonNext = appCreator.el.querySelector(
      "button.o_web_studio_app_creator_next"
    );
  ...
  QUnit.test('app creator: navigate through steps using "ENTER"', async function (
    assert
  ) {
    assert.expect(12);
