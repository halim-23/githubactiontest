odoo.define("web_studio.NewFieldDialog", function (require) {
  ...
  var NewFieldDialog = Dialog.extend(StandaloneFieldManagerMixin, {
    ...
    events: {
      ...
      "blur .o_web_studio_selection_editor .o_web_studio_selection_input":
        "_onSelectionInputBlur",
    },
    /**
     * @class
    ...
    _onAddSelectionValue: function (e) {
      if (e.type === "keyup" && e.which !== $.ui.keyCode.ENTER) {
        return;
      }
    ...
    _onEditSelectionValue: function (ev) {
      ...
      if (config.isDebug()) {
        ...
        var index = _.findIndex(this.selection, function (el) {
          return el[0] === val;
        });
        new Dialog(this, {
          title: _t("Edit Value"),
          size: "small",
          $content: $(
            qweb.render("web_studio.SelectionValues.edit", {
        ...
        $input
          .val($span.toggleClass("d-none").text().trim())
          .toggleClass("d-none")
          .focus();
      }
    },
    ...
    _onRemoveSelectionValue: function (e) {
      ...
      var element = _.find(this.selection, function (el) {
        return el[0] === val;
      });
