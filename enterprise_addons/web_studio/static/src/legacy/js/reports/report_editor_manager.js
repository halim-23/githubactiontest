odoo.define("web_studio.ReportEditorManager", function (require) {
  ...
  var ReportEditorManager = AbstractEditorManager.extend(WidgetAdapterMixin, {
    className:
      AbstractEditorManager.prototype.className + " o_web_studio_report_editor_manager",
    ...
    _applyChangeHandling: function (result, opID, from_xml) {
      ...
      if (result.report_html.error) {
        ...
        this.displayNotification({
          title: _t("Error when compiling AST"),
          message: msg,
          sticky: true,
          type: "danger",
        });
    ...
    _setPaperFormat: function () {
      ...
      $container.css({
        "padding-top":
          Math.max(0, (format.margin_top || 0) - (format.header_spacing || 0)) + "mm",
