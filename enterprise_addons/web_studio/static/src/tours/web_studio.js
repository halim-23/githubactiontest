  ...
  [
    {
      ...
      content: _t(
        "Want to customize the background? Let’s activate <b>Odoo Studio</b>."
      ),
      position: "bottom",
...
tour.register(
  ...
  [
    ...
    },
    {
      ...
      content: _t(
        "How do you want to name your first <b>menu</b>? My books, My courses?"
      ),
      position: "right",
      run: "text " + utils.randomString(6),
    },
    ...
    },
    {
      ...
      content: _t(
        "Good job! To add more <b>fields</b>, come back to the <i>Add tab</i>."
      ),
      position: "bottom",
    },
    {
