odoo.define("account_followup.FollowupFormModel", function (require) {
  ...
  var FollowupFormModel = BasicModel.extend({
     ...
     *
     * @returns {Object} Informations about the progress of the job
     */
    ...
    /**
     *
     * @returns {Integer} number of skipped partners
     */
    ...
    /**
     * @returns {Boolean} true is all followups are done or skipped.
     */
     ...
     *
     * @param {String} handle Local resource id of a record
     * @returns {integer} index of the next record
     */
    ...
    updateNextAction: function (handle, action) {
      ...
      var next_action_date = field_utils.parse.date(
        record.data.next_action_date,
        {},
        {}
      );
      return this._rpc({
