...
def _generate_assessment_note_ids(cr, registry):
    ...
    default_employee_feedback = env[
        "res.company"
    ]._get_default_employee_feedback_template()
    default_manager_feedback = env[
        "res.company"
    ]._get_default_manager_feedback_template()
    default_confirmation_mail_template = env[
        "res.company"
    ]._get_default_appraisal_confirm_mail_template()
