...
class TestHrAppraisal(TransactionCase):
    ...
    def setUp(self):
        ...
        self.job = self.env["hr.job"].create(
            {"name": "Developer Test", "department_id": self.dep_rd.id}
        )
        self.colleague = self.env["hr.employee"].create(
            {"name": "Colleague Test", "department_id": self.dep_rd.id}
        )
        ...
        self.hr_employee = self.HrEmployee.create(
            dict(
                name="Michael Hawkins",
        ...
        self.hr_employee.write(
            {"work_location_id": [(0, 0, {"name": "Grand-Rosière"})]}
        )
    ...
    def test_hr_appraisal(self):
        ...
        self.assertEqual(
            appraisals.state, "pending", "appraisal should be 'Appraisal Sent' state"
        )
        ...
        self.assertTrue(
            appraisals.date_final_interview, "Interview Date is not created"
        )
    ...
    def test_new_employee_next_appraisal_date_generation(self):
        ...
        # a later date
        hr_employee3 = self.HrEmployee.create(
            dict(
                name="Jane Doe",
            )
        )
    ...
    def test_01_appraisal_generation(self):
        ...
        """
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=6, days=-8
        )
        ...
        self.assertEqual(
            self.hr_employee.next_appraisal_date, date.today() + relativedelta(days=8)
        )

        self.env["res.company"]._run_employee_appraisal_plans()
        appraisals_2 = self.HrAppraisal.search(
            [("employee_id", "=", self.hr_employee.id)]
        )
    ...
    def test_07_check_manual_appraisal_set_appraisal_date(self):
        ...
        self.assertEqual(
            self.hr_employee.next_appraisal_date, date.today() + relativedelta(months=1)
        )
    ...
    def test_09_check_appraisal_after_recruitment(self):
        ...
        since recruitment
        """
        self.hr_employee.create_date = date.today() - relativedelta(
            months=self.duration_after_recruitment, days=10
        )
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=self.duration_after_recruitment, days=10
        )
    ...
    def test_10_check_no_appraisal_since_recruitment_appraisal(self):
        ...
        """
        self.hr_employee.create_date = date.today() - relativedelta(
            months=self.duration_after_recruitment + 2, days=10
        )
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=2, days=10
        )
    ...
    def test_11_check_first_appraisal_since_recruitment_appraisal(self):
        ...
        """
        self.hr_employee.create_date = date.today() - relativedelta(
            months=self.duration_after_recruitment + self.duration_first_appraisal,
            days=10,
        )
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=self.duration_first_appraisal, days=10
        )
        ...
        self.HrAppraisal.create(
            {
                ...
                - relativedelta(months=self.duration_first_appraisal, days=10),
                "state": "done",
            }
        )
    ...
    def test_12_check_no_appraisal_after_first_appraisal(self):
        ...
        """
        self.hr_employee.create_date = date.today() - relativedelta(
            months=self.duration_after_recruitment + self.duration_first_appraisal + 2,
            days=10,
        )
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=2, days=10
        ...
        self.HrAppraisal.create(
            {
                "employee_id": self.hr_employee.id,
                "date_close": date.today()
                - relativedelta(months=self.duration_first_appraisal + 2, days=10),
                "state": "done",
            }
        )
        self.HrAppraisal.create(
        ...
        self.env["res.company"]._run_employee_appraisal_plans()
        appraisals = self.HrAppraisal.search(
            [("employee_id", "=", self.hr_employee.id), ("state", "=", "new")]
        )
        self.assertFalse(appraisals, "Appraisal created")
    ...
    def test_12_check_recurring_appraisal(self):
        ...
        self.hr_employee.create_date = date.today() - relativedelta(
            months=self.duration_after_recruitment
            + self.duration_first_appraisal
            + self.duration_next_appraisal,
            days=10,
        )
        self.hr_employee.last_appraisal_date = date.today() - relativedelta(
            months=self.duration_next_appraisal, days=10
        )
        ...
        self.HrAppraisal.create(
            {
                ...
                "date_close": date.today()
                - relativedelta(
                    months=self.duration_first_appraisal + self.duration_next_appraisal,
                    days=10,
                ),
                "state": "done",
            }
        ...
        self.HrAppraisal.create(
            {
                "employee_id": self.hr_employee.id,
                "date_close": date.today()
                - relativedelta(months=self.duration_next_appraisal, days=10),
                "state": "done",
            }
        )
