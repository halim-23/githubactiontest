...
class TestAdvantages(TransactionCase):
    ...
    def test_yearly_cost_new_advantage(self):
        ...
        with patch.object(
            ...
            lambda self: advantage_costs(self) + self[fieldname],
        ):
        ...
        self.assertEqual(
            self.contract.final_yearly_costs,
            12 * (self.contract.wage + 50),
            "The new advantage should have updated the yearly cost",
        )
    ...
    def test_final_yearly_costs(self):
        ...
        self.assertAlmostEqual(
            self.contract.final_yearly_costs, 100000, 2
        )  # And not 99999.96
