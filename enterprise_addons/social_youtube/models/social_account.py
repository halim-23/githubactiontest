...
class SocialAccountYoutube(models.Model):
    ...
    youtube_channel_id = fields.Char(
        "Youtube Channel ID",
        readonly=True,
    ...
    def _compute_stats_link(self):
        ...
        for account in youtube_accounts:
            account.stats_link = (
                "https://studio.youtube.com/channel/%s/analytics/tab-overview"
    ...
    def _compute_statistics(self):
        ...
        endpoint_url = url_join(
            self.env["social.media"]._YOUTUBE_ENDPOINT, "youtube/v3/channels"
        )
    ...
    def create(self, vals_list):
        ...
        )._create_default_stream_youtube()
        return res
    ...
    def _refresh_youtube_token(self):
        ...
        for account in self:
            if (
                not account.youtube_token_expiration_date
                or account.youtube_token_expiration_date > fields.Datetime.now()
            ):
                continue
