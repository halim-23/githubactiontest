  ...
  var YoutubeUploadField = basicFields.FieldChar.extend({
    ...
    _awaitPostProcessing: function (uploadedVideoId) {
      return new Promise((resolve, reject) => {
        ...
        this.processingInfoInterval = setInterval(
          this._updateProcessingInfo.bind(this),
          1500
        );
      });
    },
      ...
      xhr.upload.addEventListener(
        ...
        function (e) {
          if (e.lengthComputable) {
            ...
            self
              .$(".o_social_youtube_upload_progress")
              .css("width", roundedProgress + "%");
            self
              .$(".o_social_youtube_upload_text")
              .text(_.str.sprintf(_t("Uploading... %s"), roundedProgress + "%"));
          }
        },
        false
      );
        ...
        $.ajax({
          ...
          beforeSend: (request) => {
            request.setRequestHeader(
              "Authorization",
              "Bearer " + self._getYoutubeAccessToken()
            );
      ...
      $.ajax({
        ...
        success: function (response) {
          if (
            ...
            "processingDetails" in response.items[0]
          ) {
