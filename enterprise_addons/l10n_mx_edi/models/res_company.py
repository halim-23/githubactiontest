...
class ResCompany(models.Model):
    ...
    l10n_mx_edi_pac = fields.Selection(
        selection=[
            ("finkok", "Quadrum (formerly finkok)"),
    ...
    l10n_mx_edi_pac_username = fields.Char(
        string="PAC username", help="The username used to request the seal from the PAC"
    )
    l10n_mx_edi_pac_password = fields.Char(
        string="PAC password", help="The password used to request the seal from the PAC"
    )
    l10n_mx_edi_certificate_ids = fields.Many2many(
        "l10n_mx_edi.certificate", string="Certificates (MX)"
    )
    ...
    l10n_mx_edi_colony = fields.Char(
        compute="_compute_l10n_mx_edi_colony", inverse="_inverse_l10n_mx_edi_colony"
    )
