...
class TestSignRequest(TestSignCommon):
    ...
    def test_sign_request_item_auto_resend(self, _create_log):
        ...
        self.assertEqual(
            request_item.signer_email,
            "laurie.poiret.a@example.com",
            "email address should be laurie.poiret.a@example.com",
        )
        ...
        self.assertEqual(
            ...
            token_a,
            "sign request item's access token should not be changed",
        )
        ...
        self.assertEqual(
            request_item.signer_email,
            "laurie.poiret.b@example.com",
            "email address should be laurie.poiret.b@example.com",
        )
        self.assertNotEqual(
            token_b, token_a, "sign request item's access token should be changed"
        )
        # sign the document
        ...
        self.assertEqual(
            token_c,
            token_b,
            "sign request item's access token should be not changed after the document is signed by the signer",
        )

    def test_templates_send_accesses(self):
        for sign_request in [
            self.default_role_sign_request,
            self.multi_role_sign_request,
            self.single_role_sign_request,
        ]:
