odoo.define("sign.tour", function (require) {
  ...
  tour.register(
    ...
    [
      ...
      {
        trigger:
          '.o_nocontent_help p a:contains("' +
          _t("start with our sample template") +
          '")',
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "And finally, <b>drag & drop “Signature”</b> into the bottom of the document."
          )
        ),
        position: "right",
      },
      {
        ...
        content: Markup(
          _t("Well done, your document is ready!<br>Let's sign it directly.")
        ),
        position: "bottom",
      },
      {
  ...
  tour.register(
    "sign_tour_with_multiple_signatures",
    {
      url: "/web",
      rainbowManMessage: "<b>Congratulations</b>, your first document is fully signed!",
      sequence: 150,
    ...
    [
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "Let's add another signature, <b>drag & drop “Signature”</b> into the bottom of the document."
          )
        ),
        position: "right",
      },
