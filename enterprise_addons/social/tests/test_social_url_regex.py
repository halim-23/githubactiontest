...
class TestUrlRegex(TransactionCase):
    def test_url_regex(self):
        ...
        self.assertEqual(
            url_www, "www.google.com", "The Google URL should be extracted"
        )
        ...
        self.assertEqual(
            url_https, "https://facebook.com", "The Facebook URL should be extracted"
        )
        ...
        self.assertEqual(
            ...
            "The Twitter URL should be extracted",
        )
