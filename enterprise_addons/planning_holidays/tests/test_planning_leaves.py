...
class TestPlanningLeaves(TestCommon):
    def test_simple_employee_leave(self):
        ...
        self.assertNotEqual(
            slot_1.with_context(include_past=True).leave_warning,
            False,
        ...
        self.assertEqual(
            slot_2.with_context(include_past=True).leave_warning,
            False,
    ...
    def test_multiple_leaves(self):
        ...
        self.assertEqual(
            slot_3.with_context(include_past=True).leave_warning,
            "patrick is on time off from the 01/06/2020 to the 01/10/2020. \n",
