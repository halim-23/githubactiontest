...
class Task(models.Model):
    ...
    def _compute_display_timesheet_timer(self):
        for task in self:
            task.display_timesheet_timer = (
                task.allow_timesheets and task.analytic_account_active
            )
    ...
    def action_timer_stop(self):
        ...
        if self.user_timer_id.timer_start and self.display_timesheet_timer:
            rounded_hours = self._get_rounded_hours(
                self.user_timer_id._get_minutes_spent()
            )
