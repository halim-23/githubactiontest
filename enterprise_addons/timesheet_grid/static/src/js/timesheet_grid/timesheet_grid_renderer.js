  ...
  class TimesheetM2OAvatarEmployeeAdapter extends ComponentAdapter {
    ...
    get widgetArgs() {
      return [
        this.props.value,
        this.props.rowIndex,
        this.props.rangeContext,
        this.props.timeBoundariesContext,
        this.props.workingHoursData,
      ];
    }
  }
  ...
  class TimesheetGridRenderer extends GridRenderer {
    ...
    get showEmployeeAvatar() {
      ...
      if (this.props.isGrouped) {
        ...
        const isLabelAnEmployee =
          !isGroupLabel && empIdGroupIndex === this.label_index + 1;
