  ...
  QUnit.module(
    ...
    function () {
      ...
      QUnit.test("empty ungrouped gantt rendering", async function (assert) {
        ...
        assert.containsN(
          gantt,
          ".o_gantt_header_container .o_gantt_header_scale .o_gantt_header_cell",
          31,
          "should have a 31 slots for month view"
        );
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row",
          "should have a 1 row"
        );
      ...
      QUnit.test("ungrouped gantt rendering", async function (assert) {
        ...
        assert.containsOnce(gantt, ".o_gantt_header_container", "should have a header");
        assert.hasClass(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=month]"),
          "active",
          "month view should be activated by default"
        );
        assert.notOk(
          gantt.$buttons.find(".o_gantt_button_expand_rows").is(":visible"),
          "the expand button should be invisible (only displayed if useful)"
        );
        assert.strictEqual(
          gantt.$(".o_gantt_header_container > .col > .row:first-child").text().trim(),
          "December 2018",
        ...
        assert.containsNone(
          gantt,
          ".o_gantt_row_container .o_gantt_row .o_gantt_row_sidebar",
          "should not have a sidebar"
        );
        assert.containsN(gantt, ".o_gantt_pill_wrapper", 6, "should have a 6 pills");

        // Verify that the level offset is correctly applied (add 1px gap border compensation for each level)
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-01 00:00:00"] .o_gantt_pill_wrapper:contains(Task 1)'
            )
            .css("margin-top"),
          "2px",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-01 00:00:00"] .o_gantt_pill_wrapper:contains(Task 5)'
            )
            .css("margin-top"),
          GanttRow.prototype.LEVEL_TOP_OFFSET + 4 + 2 + "px",
          "task 5 should be in second level"
        );
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-17 00:00:00"] .o_gantt_pill_wrapper:contains(Task 2)'
            )
            .css("margin-top"),
          GanttRow.prototype.LEVEL_TOP_OFFSET + 4 + 2 + "px",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-20 00:00:00"] .o_gantt_pill_wrapper:contains(Task 4)'
            )
            .css("margin-top"),
          2 * (GanttRow.prototype.LEVEL_TOP_OFFSET + 4) + 2 + "px",
          "task 4 should be in third level"
        );
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-20 00:00:00"] .o_gantt_pill_wrapper:contains(Task 7)'
            )
            .css("margin-top"),
          2 * (GanttRow.prototype.LEVEL_TOP_OFFSET + 4) + 2 + "px",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_cell[data-date="2018-12-27 00:00:00"] .o_gantt_pill_wrapper:contains(Task 3)'
            )
            .css("margin-top"),
          GanttRow.prototype.LEVEL_TOP_OFFSET + 4 + 2 + "px",
        ...
        assert.strictEqual(
          $("div.popover .flex-column span:nth-child(2)").text(),
          startDateLocalString,
          "popover should display start date of task 2 in local time"
        );
        assert.strictEqual(
          $("div.popover .flex-column span:nth-child(3)").text(),
          stopDateLocalString,
          "popover should display start date of task 2 in local time"
        );
      ...
      QUnit.test("ordered gantt view", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" progress="progress"></gantt>',
          groupBy: ["stage_id"],
          viewOptions: {
            initialDate: initialDate,
          },
        ...
        assert.strictEqual(
          gantt.$(".o_gantt_row_title").text().replace(/\s/g, ""),
      ...
      QUnit.test("single-level grouped gantt rendering", async function (assert) {
        ...
        assert.strictEqual(
          gantt.$(".o_gantt_header_container > .o_gantt_row_sidebar").text().trim(),
          "Tasks",
        ...
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:nth-child(2) .o_gantt_row_sidebar",
          "should have a sidebar"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth-child(2) .o_gantt_row_title")
            .text()
            .trim(),
          "Project 1",
        ...
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_row:nth-child(2) .o_gantt_pill_wrapper",
          4,
          "should have a 4 pills in first row"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:last-child .o_gantt_row_title")
            .text()
            .trim(),
          "Project 2",
        ...
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_row:last-child .o_gantt_pill_wrapper",
          2,
      ...
      QUnit.test(
        "single-level grouped gantt rendering with group_expand",
        async function (assert) {
          ...
          assert.strictEqual(
            gantt
              .$(".o_gantt_header_container > .col > .row:first-child")
              .text()
              .trim(),
            "December 2018",
            'should contain "December 2018" in header'
          ...
          assert.containsN(
            gantt,
            ".o_gantt_row_container .o_gantt_row:not(.o_gantt_total_row):last-child .o_gantt_pill_wrapper",
            4,
      ...
      QUnit.test("multi-level grouped gantt rendering", async function (assert) {
        ...
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_row_group.open",
          6,
          "should have a 6 opened groups"
        );
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_row:not(.o_gantt_row_group)",
          6,
          "should have a 6 rows"
        );
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:first .o_gantt_row_sidebar",
          "should have a sidebar"
        );

        // Check grouped rows
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:first"),
          "o_gantt_row_group",
          "1st row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:first .o_gantt_row_title")
            .text()
            .trim(),
          "User 1",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(1)"),
          "o_gantt_row_group",
          "2nd row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(1) .o_gantt_row_title")
            .text()
            .trim(),
          "Project 1",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(4)"),
          "o_gantt_row_group",
          "5th row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(4) .o_gantt_row_title")
            .text()
            .trim(),
          "Project 2",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(6)"),
          "o_gantt_row_group",
          "7th row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(6) .o_gantt_row_title")
            .text()
            .trim(),
          "User 2",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(7)"),
          "o_gantt_row_group",
          "8th row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(7) .o_gantt_row_title")
            .text()
            .trim(),
          "Project 1",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(10)"),
          "o_gantt_row_group",
          "11th row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(10) .o_gantt_row_title")
            .text()
            .trim(),
          "Project 2",
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(0) .o_gantt_consolidated_pill_title")
            .text()
            .replace(/\s+/g, ""),
          "2121",
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(0) .o_gantt_pill:eq(0)")
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(0) .o_gantt_pill:eq(1)")
            .css("background-color"),
          "rgb(1, 126, 132)",
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(0) .o_gantt_pill:eq(2)")
            .css("background-color"),
          "rgb(1, 126, 132)",
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(0) .o_gantt_pill:eq(3)")
            .css("background-color"),
          "rgb(1, 126, 132)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(0) .o_gantt_pill_wrapper:eq(0)")
          ),
          "calc(300% + 2px - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(0) .o_gantt_pill_wrapper:eq(1)")
          ),
          "calc(1600% + 15px - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(0) .o_gantt_pill_wrapper:eq(2)")
          ),
          "calc(50% - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(0) .o_gantt_pill_wrapper:eq(3)")
          ),
          "calc(1150% + 10px - 0px)",
      ...
      QUnit.test("many2many grouped gantt rendering", async function (assert) {
        ...
        this.data.tasks.fields.user_ids = {
          string: "Assignees",
          type: "many2many",
          relation: "users",
        };
        ...
        assert.containsOnce(gantt, ".o_gantt_header_container", "should have a header");
        assert.hasClass(
          gantt.$(".o_gantt_button_scale[data-value=month]"),
          "active",
          "month view should by default activated"
        );
        assert.notOk(
          gantt.$(".o_gantt_button_expand_rows").is(":visible"),
          "the expand button should be invisible (only displayed if useful)"
        );
        assert.strictEqual(
          gantt.$(".o_gantt_header_container > .o_gantt_row_sidebar").text().trim(),
        ...
        assert.strictEqual(
          gantt
            ...
            .trim(),
          "User 1",
          'should contain "User 1" in sidebar title'
        );
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:nth-child(2) .o_gantt_pill_wrapper",
          "should have a single pill in first row"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth-child(2) .o_gantt_pill_wrapper")
            ...
            .trim(),
          "Task 1",
          "pills should have those names in first row"
        );

        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:nth-child(3) .o_gantt_row_sidebar",
          "should have a sidebar"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth-child(3) .o_gantt_row_title")
            .text()
            .trim(),
          "User 2",
        ...
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:nth-child(3) .o_gantt_pill_wrapper",
        ...
        assert.containsOnce(
          gantt,
          ".o_gantt_row_container .o_gantt_row:last-child .o_gantt_row_sidebar",
          "should have a sidebar"
        );
        assert.strictEqual(
          gantt
            ...
            .trim(),
          "Undefined Assignees",
          'should contain "Undefined Assignees" in sidebar title'
        );
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_row:last-child .o_gantt_pill_wrapper",
          5,
          "should have 5 pills in last row"
        );
        assert.deepEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:last-child .o_gantt_pill_wrapper")
            .text()
            .match(/(\w+\s\d)/g),
          ["Task 5", "Task 2", "Task 4", "Task 7", "Task 3"],
          "pills should have those names in last row"
        );

        assert.deepEqual(
          [...gantt.el.querySelectorAll(".o_gantt_pill")].map((el) => el.dataset.id),
          ["1", "1", "5", "2", "4", "7", "3"],
      ...
      QUnit.test(
        "multi-level grouped with many2many field in gantt view",
        async function (assert) {
          assert.expect(20);
          ...
          assert.hasClass(
            gantt.el.querySelector(".o_gantt_button_scale[data-value=month]"),
            "active"
          );
          assert.containsOnce(
            gantt,
            ".btn-group:not(.d-none) > .o_gantt_button_expand_rows",
            "there should be an expand button"
          );
          assert.strictEqual(
            gantt.el.querySelector(".o_gantt_header_container > .o_gantt_row_sidebar")
              .innerText,
            "Tasks",
            "should contain 'Tasks' in header sidebar"
          );
          assert.strictEqual(
            gantt.el.querySelector(".o_gantt_header_slots > .row:first-child")
              .innerText,
            "December 2018",
            "should contain 'December 2018' in header"
          );
          assert.containsN(
            gantt,
            ".o_gantt_header_scale .o_gantt_header_cell",
            31,
            "should have a 31 slots for month view"
          );
          ...
          assert.containsN(
            ...
            ".o_gantt_row_container .o_gantt_row .o_gantt_row_sidebar",
            7,
            "each rowshould have a sidebar"
          );
          assert.containsN(
            gantt,
            ".o_gantt_row_container .o_gantt_row_group.open",
            3,
            "should have 3 opened groups"
          );
          assert.containsN(
            gantt,
            ".o_gantt_row_container .o_gantt_row_nogroup",
            4,
            "should have 4 'nogroup' rows"
          );
          ...
          const rowGroupClasses = [...rows].map((el) => {
            return [...el.classList]
              .filter((c) => c.startsWith("o_gantt_row_"))[0]
              .substring(12);
          });
          assert.deepEqual(
            rowGroupClasses,
            ["group", "nogroup", "group", "nogroup", "group", "nogroup", "nogroup"],
            "rows should be '(no)group' in this order"
          );

          const rowTitles = [...rows].map((el) =>
            el.querySelector(".o_gantt_row_title").innerText.trim()
          );
          assert.deepEqual(
            rowTitles,
            [
          ...
          const groupCounts = [...rows]
            .filter((el) => [...el.classList].includes("o_gantt_row_group"))
            .map((el) =>
              [...el.querySelectorAll(".o_gantt_consolidated_pill_title")]
                .map((x) => x.innerText)
                .join()
            );
          assert.deepEqual(
            groupCounts,
            ["1", "1", "1,1,2,1,1"],
            "group consolidated counts should be correctly computed"
          );
          ...
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(1) .o_gantt_pill_wrapper:eq(0)")
            ),
            "calc(3100% + 30px - 0px)"
          );
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(2) .o_gantt_pill_wrapper:eq(0)")
            ),
            "calc(300% + 2px - 0px)"
          );
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(2) .o_gantt_pill_wrapper:eq(1)")
            ),
            "calc(250% + 1px - 0px)"
          );
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(2) .o_gantt_pill_wrapper:eq(2)")
            ),
            "calc(100% - 0px)"
          );
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(2) .o_gantt_pill_wrapper:eq(3)")
            ),
            "calc(150% - 0px)"
          );
          assert.strictEqual(
            getPillItemWidth(
              gantt.$(".o_gantt_row_group:eq(2) .o_gantt_pill_wrapper:eq(4)")
            ),
            "calc(500% + 4px - 0px)"
          );
      ...
      QUnit.test("gantt rendering, thumbnails", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt string="Tasks" date_start="start" date_stop="stop" thumbnails="{\'user_id\': \'image\'}" />',
          viewOptions: {
            initialDate: initialDate,
          },
          groupBy: ["user_id"],
        ...
        assert.containsN(
          ...
          1,
          "There should be a thumbnail per row where user_id is defined"
        );

        assert.ok(
          gantt
            .$(".o_gantt_row_thumbnail:nth(0)")[0]
      ...
      QUnit.test("scale switching", async function (assert) {
        ...
        await testUtils.dom.click(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=day]")
        );
        assert.hasClass(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=day]"),
          "active",
        ...
        assert.containsN(gantt, ".o_gantt_pill_wrapper", 4, "should have a 4 pills");

        // Switch to week view
        await testUtils.dom.click(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=week]")
        );
        assert.hasClass(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=week]"),
          "active",
        ...
        // Switch to year view
        await testUtils.dom.click(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=year]")
        );
        assert.hasClass(
          gantt.$buttons.find(".o_gantt_button_scale[data-value=year]"),
          "active",
        ...
        assert.containsN(gantt, ".o_gantt_pill_wrapper", 7, "should have a 7 pills");
      ...
      QUnit.test("today is highlighted", async function (assert) {
        ...
        assert.strictEqual(
          parseInt(gantt.$(".o_gantt_header_cell.o_gantt_today").text(), 10),
          dayOfMonth,
      ...
      QUnit.test('empty grouped gantt with sample="1"', async function (assert) {
        ...
        assert.ok(
          gantt.$(".o_gantt_pill_wrapper").length > 0,
          "sample records should be displayed"
        );
      ...
      QUnit.test("empty gantt with sample data and default_group_by", async function (
        assert
      ) {
        assert.expect(5);
      ...
      QUnit.test(
        ...
        async function (assert) {
          ...
          assert.hasClass(
            $(webClient.el).find(".o_view_controller"),
            "o_view_sample_data"
          );
          assert.ok(
            $(webClient.el).find(".o_gantt_pill_wrapper").length > 0,
            "sample records should be displayed"
          );
          ...
          // Switch to list view
          await testUtils.dom.click(
            $(webClient.el).find(".o_cp_bottom_right .o_switch_view.o_list")
          );
          await nextTick();
          ...
          await testUtils.dom.click(
            $(webClient.el).find(".o_cp_bottom_right .o_switch_view.o_gantt")
          );
          await nextTick();
          ...
          assert.strictEqual(
            $(webClient.el).find(".o_view_controller").text(),
            content
          );
        }
      );
      ...
      QUnit.test('toggle filter on empty gantt with sample="1"', async function (
        assert
      ) {
        assert.expect(6);
      ...
      QUnit.test('non empty gantt with sample="1"', async function (assert) {
        ...
        const gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" default_scale="year" sample="1"/>',
          viewOptions: {initialDate},
        });
      ...
      QUnit.test(
        'click add and discard in empty gantt with sample="1"',
        async function (assert) {
          assert.expect(3);
      ...
      QUnit.test('click button scale in empty gantt with sample="1"', async function (
        assert
      ) {
        assert.expect(11);
      ...
      QUnit.test('click today button in empty gantt with sample="1"', async function (
        assert
      ) {
        assert.expect(5);
      ...
      QUnit.test(
        'click prev/next button in empty gantt with sample="1"',
        async function (assert) {
          assert.expect(7);
      ...
      QUnit.test(
        "empty grouped gantt with sample data: keyboard navigation",
        async function (assert) {
          assert.expect(2);
      ...
      QUnit.test("no content helper when no data and sample mode", async function (
        assert
      ) {
        assert.expect(3);
        ...
        assert.strictEqual(
          gantt.$(".o_view_nocontent p.hello:contains(add a partner)").length,
          1,
      ...
      QUnit.test("date navigation with timezone (1h)", async function (assert) {
        ...
        assert.verifySteps([
          "start,<=,2018-12-31 22:59:59,stop,>=,2018-11-30 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-11-30 22:59:59,stop,>=,2018-10-31 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-12-20 22:59:59,stop,>=,2018-12-19 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-12-19 22:59:59,stop,>=,2018-12-18 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-12-22 22:59:59,stop,>=,2018-12-15 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-12-15 22:59:59,stop,>=,2018-12-08 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2018-12-31 22:59:59,stop,>=,2017-12-31 23:00:00",
        ]);
        ...
        assert.verifySteps([
          "start,<=,2017-12-31 22:59:59,stop,>=,2016-12-31 23:00:00",
        ]);
      ...
      QUnit.test(
        ...
        async function (assert) {
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" on_create="this_is_create_action" />',
            viewOptions: {
              initialDate: initialDate,
            },
            mockRPC: function (route, args) {
      ...
      QUnit.test(
        "if a cell_create is specified to false then do not show + icon",
        async function (assert) {
          assert.expect(2);
      ...
      QUnit.test("open a dialog to add a new task", async function (assert) {
        ...
        assert.strictEqual(
          $modal.find(".o_field_widget[name=start] .o_input").val(),
          "12/01/2018 00:00:00",
          "the start date should be the start of the focus month"
        );
        assert.strictEqual(
          $modal.find(".o_field_widget[name=stop] .o_input").val(),
          "12/31/2018 23:59:59",
      ...
      QUnit.test("open a dialog to create/edit a task", async function (assert) {
        ...
        await testUtils.dom.triggerMouseEvent(
          gantt.$(
            '.o_gantt_row_container .o_gantt_row:nth(3) .o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_cell_add'
          ),
          "click"
        );
        await testUtils.nextTick();
        ...
        assert.strictEqual(
          $modalFieldStart.find(".o_input").val(),
          "12/10/2018 00:00:00",
          'The start field should have a value "12/10/2018 00:00:00"'
        );
        var $modalFieldStop = $modal.find(".o_field_widget[name=stop]");
        assert.strictEqual(
          $modalFieldStop.find(".o_input").val(),
          "12/10/2018 23:59:59",
          'The stop field should have a value "12/10/2018 23:59:59"'
        );
        var $modalFieldProject = $modal.find(
          ".o_field_widget.o_field_many2one[name=project_id]"
        );
        assert.strictEqual(
          $modalFieldProject.find(".o_input").val(),
          "Project 1",
          'The project field should have a value "Project 1"'
        );
        var $modalFieldUser = $modal.find(
          ".o_field_widget.o_field_many2one[name=user_id]"
        );
        assert.strictEqual(
          $modalFieldUser.find(".o_input").val(),
          "User 1",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_row:nth(3) .o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_pill'
            )
            .text()
            .trim(),
          "Task 8",
      ...
      QUnit.test(
        "open a dialog to create a task when grouped by many2many field",
        async function (assert) {
          assert.expect(22);
          ...
          assert.deepEqual(
            [...rows].map((row) =>
              row.querySelector(".o_gantt_row_title").innerText.trim()
            ),
            [
              "User 1",
              "Project 1",
          ...
          assert.deepEqual(
            [...rows]
              .filter((row) => row.classList.contains("o_gantt_row_nogroup"))
              .reduce((acc, row) => {
                acc[row.dataset.rowId] = [
                  ...row.querySelectorAll(".o_gantt_pill_title"),
                ].map((pill) => pill.innerText);
                return acc;
              }, {}),
            {
              '[{"user_ids":[1,"User 1"]},{"project_id":[1,"Project 1"]}]': ["Task 1"],
              '[{"user_ids":[2,"User 2"]},{"project_id":[1,"Project 1"]}]': ["Task 1"],
          ...
          let row = gantt.el.querySelector(
            `[data-row-id*="User 1"][data-row-id*="Project 1"]`
          );
          await testUtils.dom.triggerMouseEvent(
            row.querySelector(
              ".o_gantt_cell[data-date='2018-12-10 00:00:00'] .o_gantt_cell_add"
            ),
            "click"
          );
          await testUtils.nextTick();
          ...
          let $fieldProject = $modal.find(
            ".o_field_widget.o_field_many2one[name=project_id]"
          );
          let $fieldUser = $modal.find(
            ".o_field_widget.o_field_many2manytags[name=user_ids]"
          );
          assert.strictEqual(
            $fieldDateStart.find(".o_input").val(),
            "12/10/2018 00:00:00",
            "The date start field should have a value '12/10/2018 00:00:00'"
          );
          assert.strictEqual(
            $fieldDateStop.find(".o_input").val(),
            "12/10/2018 23:59:59",
            "The date stop field should have a value '12/10/2018 23:59:59'"
          );
          assert.strictEqual(
            $fieldProject.find(".o_input").val(),
            "Project 1",
            "The project field should have a value 'Project 1'"
          );
          assert.containsOnce(
            $fieldUser,
            ".badge",
            "The user field should contain a single badge"
          );
          assert.strictEqual(
            $fieldUser.find(".badge .o_tag_badge_text").text().trim(),
            "User 1",
            "The user field should have a value 'User 1'"
          );
          ...
          row = gantt.el.querySelector(
            `[data-row-id*="Project 2"]:not([data-row-id*="User"])`
          );
          await testUtils.dom.triggerMouseEvent(
            row.querySelector(
              ".o_gantt_cell[data-date='2018-12-24 00:00:00'] .o_gantt_cell_add"
            ),
            "click"
          );
          await testUtils.nextTick();
          ...
          $fieldProject = $modal.find(
            ".o_field_widget.o_field_many2one[name=project_id]"
          );
          $fieldUser = $modal.find(
            ".o_field_widget.o_field_many2manytags[name=user_ids]"
          );
          assert.strictEqual(
            $fieldDateStart.find(".o_input").val(),
            "12/24/2018 00:00:00",
            "The date start field should have a value '12/24/2018 00:00:00'"
          );
          assert.strictEqual(
            $fieldDateStop.find(".o_input").val(),
            "12/24/2018 23:59:59",
            "The date stop field should have a value '12/24/2018 23:59:59'"
          );
          assert.strictEqual(
            $fieldProject.find(".o_input").val(),
            "Project 2",
            "The project field should have a value 'Project 2'"
          );
          assert.containsNone(
            $fieldUser,
            ".badge",
            "The user field should not contain badges"
          );
          await testUtils.fields.editInput(
            $modal.find("input[name=name]"),
            "NEWTASK 1"
      ...
      QUnit.test(
        "open a dialog to create a task, does not have a delete button",
        async function (assert) {
          assert.expect(1);
          ...
          assert.containsNone(
            $modal,
            ".o_btn_remove",
            "There should be no delete button on create dialog"
          );
      ...
      QUnit.test("open a dialog to edit a task, has a delete buttton", async function (
        assert
      ) {
        assert.expect(1);
        ...
        assert.strictEqual(
          $modal.find(".o_btn_remove").length,
          1,
          "There should be a delete button on edit dialog"
        );
      ...
      QUnit.test(
        ...
        async function (assert) {
          ...
          assert.strictEqual(
            unlinkCallCount,
            0,
            "should not call unlink on the model if dialog is cancelled"
          );
      ...
      QUnit.test("create dialog with timezone", async function (assert) {
        ...
        // Open dialog to create a task
        await testUtils.dom.triggerMouseEvent(
          gantt.$('.o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_cell_add'),
          "click"
        );
        await testUtils.nextTick();
        ...
        assert.strictEqual($(".modal").length, 1, "There should be one modal opened");
        assert.strictEqual(
          $(".modal .o_field_widget[name=start] .o_input").val(),
          "12/10/2018 00:00:00",
          'The start field should have a value "12/10/2018 00:00:00"'
        );
        assert.strictEqual(
          $(".modal .o_field_widget[name = stop] .o_input").val(),
          "12/10/2018 23:59:59",
          'The stop field should have a value "12/10/2018 23:59:59"'
        );
      ...
      QUnit.test(
        "plan button is not present if edit === false and plan is true",
        async function (assert) {
          assert.expect(1);
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" edit="false" plan="true" />',
            archs: {
              "tasks,false,list": '<tree><field name="name"/></tree>',
              "tasks,false,search": '<search><field name="name"/></search>',
            },
      ...
      QUnit.test(
        "plan button is not present if edit === true and plan === false",
        async function (assert) {
          assert.expect(1);
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" edit="true" plan="false" />',
            archs: {
              "tasks,false,list": '<tree><field name="name"/></tree>',
              "tasks,false,search": '<search><field name="name"/></search>',
            },
      ...
      QUnit.test(
        "plan button is present if edit === true and plan is not set",
        async function (assert) {
          assert.expect(1);
      ...
      QUnit.test(
        "plan button is present if edit === true and plan is true",
        async function (assert) {
          assert.expect(1);
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" edit="true" plan="true" />',
            archs: {
              "tasks,false,list": '<tree><field name="name"/></tree>',
              "tasks,false,search": '<search><field name="name"/></search>',
            },
      ...
      QUnit.test("open a dialog to plan a task", async function (assert) {
          ...
          mockRPC: function (route, args) {
            if (args.method === "write") {
              ...
              assert.deepEqual(
                args.args[0],
                [41, 42],
                "should write on the selected ids"
              );
              assert.deepEqual(
                args.args[1],
                {start: "2018-12-10 00:00:00", stop: "2018-12-10 23:59:59"},
        ...
        await testUtils.dom.triggerMouseEvent(
          gantt.$('.o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_cell_plan'),
          "click"
        );
        await testUtils.nextTick();

        assert.strictEqual(
          $(".modal .o_list_view").length,
          1,
          "a list view dialog should be opened"
        );
        assert.strictEqual(
          $(".modal .o_list_view tbody .o_data_cell").text().replace(/\s+/g, ""),
          "Task41Task42Task43",
      ...
      QUnit.test("open a dialog to plan a task (with timezone)", async function (
        assert
      ) {
        assert.expect(2);
      ...
      QUnit.test("open a dialog to plan a task (multi-level)", async function (assert) {
        ...
        await testUtils.dom.triggerMouseEvent(
          gantt.$(
            '.o_gantt_row:not(.o_gantt_row_group):first .o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_cell_plan'
          ),
          "click"
        );
        await testUtils.nextTick();
      ...
      QUnit.test("expand/collapse rows", async function (assert) {
        ...
        await testUtils.dom.click(
          gantt.$(".o_gantt_row_group:first .o_gantt_row_sidebar")
        );
        assert.containsN(
          gantt,
          ".o_gantt_row_group.open",
      ...
      QUnit.test("create a task maintains the domain", async function (assert) {
        ...
        await testUtils.dom.triggerMouseEvent(
          gantt.$(".o_gantt_cell:first .o_gantt_cell_add"),
          "click"
        );
        await testUtils.nextTick();
        await testUtils.fields.editInput(
          $(".modal .modal-body input[name=name]"),
          "new task"
        );
        await testUtils.modal.clickButton("Save & Close");
        assert.containsN(
      ...
      QUnit.test("move a pill in the same row", async function (assert) {
        ...
        var gantt = await createView({
          ...
          mockRPC: function (route, args) {
            if (args.method === "write") {
              assert.deepEqual(args.args[0], [7], "should write on the correct record");
              assert.deepEqual(
                args.args[1],
                {
        ...
        var cellWidth =
          gantt
            .$(".o_gantt_header_scale .o_gantt_header_cell:first")[0]
      ...
      QUnit.test("move a pill in the same row (with timezone)", async function (
        assert
      ) {
        assert.expect(2);
      ...
      QUnit.test(
        "move a pill in the same row (with different timezone)",
        async function (assert) {
          ...
          this.data.tasks.records[7].stop = taskStart
            .clone()
            .local()
            .hour(16)
            .utc()
          ...
          var gantt = await createView({
            ...
            mockRPC: function (route, args) {
              if (args.method === "write") {
                ...
                assert.equal(
                  moment.utc(args.args[1].start).local().hour(),
                  10,
                  "start date should have the same local time as original"
                );
                assert.equal(
                  moment.utc(args.args[1].stop).local().hour(),
                  16,
      ...
      QUnit.test("copy a pill in another row", async function (assert) {
        ...
        var gantt = await createView({
          ...
          mockRPC: function (route, args) {
            if (args.method === "copy") {
              assert.deepEqual(args.args[0], 7, "should copy the correct record");
              assert.deepEqual(
                args.args[1],
                {
                  start: "2018-12-21 10:30:12",
      ...
      QUnit.test("move a pill in another row in multi-level grouped", async function (
        assert
      ) {
        assert.expect(3);
        ...
        assert.containsN(
          gantt,
          ".o_gantt_pill.ui-draggable:not(.o_fake_draggable)",
          1,
        ...
        await testUtils.dom.dragAndDrop($pill, $pill, {
      ...
      QUnit.test(
        "move a pill in another row in multi-level grouped (many2many case)",
        async function (assert) {
          assert.expect(3);
          ...
          // Sanity check
          const draggable = gantt.el.querySelectorAll(
            ".o_gantt_pill.ui-draggable:not(.o_fake_draggable)"
          );
          assert.deepEqual(
      ...
      QUnit.test("display closest hook when pill being dragged", async function (
        assert
      ) {
        assert.expect(1);
        ...
        assert.hasClass(
          gantt.$("div[data-date='2018-12-21 00:00:00']"),
          "ui-drag-hover",
      ...
      QUnit.test("closest hook should be removed on pill drop", async function (
        assert
      ) {
        assert.expect(1);
      ...
      QUnit.test("grey pills should not be resizable nor draggable", async function (
        assert
      ) {
        assert.expect(4);
        ...
        assert.doesNotHaveClass(
          gantt.$(".o_gantt_row_group .o_gantt_pill"),
          "ui-resizable",
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row:not(.o_gantt_row_group) .o_gantt_pill"),
          "ui-resizable",
      ...
      QUnit.test(
        "should not be draggable when disable_drag_drop is set",
        async function (assert) {
          assert.expect(2);
          ...
          const gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" color="color" disable_drag_drop="1" />',
            viewOptions: {
              initialDate: initialDate,
            },
            groupBy: ["user_id", "project_id"],
      ...
      QUnit.test(
        "gantt_unavailability reloads when the view's scale changes",
        async function (assert) {
          assert.expect(11);
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt date_start="start" date_stop="stop" display_unavailability="1" />',
            viewOptions: {
              initialDate: initialDate,
            },
            mockRPC: function (route, args) {
          ...
          assert.strictEqual(
            unavailabilityCallCount,
            1,
            "view should have loaded unavailability"
          );
      ...
      QUnit.test("gantt_unavailability reload when period changes", async function (
        assert
      ) {
        assert.expect(6);
        ...
        assert.strictEqual(
          reloadCount,
          2,
          "view should have reloaded when clicking next"
        );
        assert.strictEqual(
          unavailabilityCallCount,
          2,
        ...
        assert.strictEqual(
          reloadCount,
          3,
          "view should have reloaded when clicking prev"
        );
        assert.strictEqual(
          unavailabilityCallCount,
          3,
      ...
      QUnit.test("drag&drop on other pill in grouped view", async function (assert) {
        ...
        assert.containsOnce(
          document.body,
          "div.popover h3:contains(Task 2)",
          "the pill should be display the popover"
        );
        ...
        assert.containsOnce(
          document.body,
          "div.popover h3:contains(Task 1)",
          "when drag&drop the other pills should be display the popover"
        );
        ...
        assert.containsNone(
          document.body,
          "div.popover",
          "should not have a popover anymore"
        );
      ...
      QUnit.test("create attribute", async function (assert) {
        ...
        assert.containsNone(
          gantt.$buttons.find(".o_gantt_button_add"),
          "there should be no 'Add' button"
        );

        await testUtils.dom.click(gantt.$(".o_gantt_cell:first"));

        assert.strictEqual($(".modal").length, 0, "there should be no opened modal");
      ...
      QUnit.test("edit attribute", async function (assert) {
        ...
        assert.strictEqual($(".modal").length, 1, "there should be a opened modal");
        assert.strictEqual(
      ...
      QUnit.test("total_row attribute", async function (assert) {
        ...
        assert.containsOnce(
          gantt,
          ".o_gantt_total_row_container .o_gantt_row_total",
          "should have 1 total row"
        );
        assert.containsNone(
          gantt,
          ".o_gantt_row_container .o_gantt_row_sidebar",
          "container should not have a sidebar"
        );
        assert.containsNone(
          gantt,
          ".o_gantt_total_row_container .o_gantt_row_sidebar",
          "total container should not have a sidebar"
        );
        assert.containsN(
          gantt,
          ".o_gantt_row_total .o_gantt_pill ",
          7,
          "should have a 7 pills in the total row"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_total .o_gantt_consolidated_pill_title")
            .text()
            .replace(/\s+/g, ""),
          "2123212",
      ...
      QUnit.test("scales attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" scales="month,day,trololo" />',
          viewOptions: {
            initialDate: initialDate,
          },
        });
        ...
        assert.containsN(
          gantt.$buttons,
          ".o_gantt_button_scale",
          2,
          "only 2 scales should be available"
        );
        assert.strictEqual(
          gantt.$buttons.find(".o_gantt_button_scale").first().text().trim(),
          "Month",
          "Month scale should be the first option"
        );
        assert.strictEqual(
          gantt.$buttons.find(".o_gantt_button_scale").last().text().trim(),
          "Day",
      ...
      QUnit.test("precision attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" precision=\'{"day": "hour:quarter", "week": "day:half", "month": "day", "year": "month:quarter"}\' default_scale="day" />',
          viewOptions: {
            initialDate: initialDate,
          },
          domain: [["id", "=", 7]],
        ...
        assert.strictEqual(
          gantt.$(".o_gantt_pill_resize_badge").text().trim(),
          "+15 minutes",
        ...
        await gantt.$(".ui-resizable-e").trigger(
          $.Event("mouseup", {
            which: 1,
      ...
      QUnit.test("progress attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt string="Tasks" date_start="start" date_stop="stop" progress="progress" />',
          viewOptions: {
            initialDate: initialDate,
          },
          groupBy: ["project_id"],
        ...
        assert.containsN(
          gantt,
          ".o_gantt_row_container .o_gantt_pill.o_gantt_progress",
          6,
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 1")'
            )
            .css("background-size"),
          "0% 100%",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 2")'
            )
            .css("background-size"),
          "30% 100%",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 3")'
            )
            .css("background-size"),
          "60% 100%",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 4")'
            )
            .css("background-size"),
          "0% 100%",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 5")'
            )
            .css("background-size"),
          "100% 100%",
        ...
        assert.strictEqual(
          gantt
            .$(
              '.o_gantt_row_container .o_gantt_pill.o_gantt_progress:contains("Task 7")'
            )
            .css("background-size"),
          "80% 100%",
      ...
      QUnit.test("form_view_id attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt string="Tasks" date_start="start" date_stop="stop" form_view_id="42"/>',
          viewOptions: {
            initialDate: initialDate,
          },
          groupBy: ["project_id"],
      ...
      QUnit.test("decoration attribute with date", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" decoration-danger="start &lt; today">' +
            "</gantt>",
          viewOptions: {
            initialDate: initialDate,
          },
      ...
      QUnit.test("consolidation feature", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt string="Tasks" date_start="start" date_stop="stop" consolidation="progress" consolidation_max=\'{"user_id": 100}\' consolidation_exclude="exclude" progress="progress"/>',
          viewOptions: {
            initialDate: initialDate,
          },
          groupBy: ["user_id", "project_id", "stage"],
        ...
        assert.hasClass(
          gantt.$(".o_gantt_row_container .o_gantt_row:nth(9)"),
          "o_gantt_row_group",
          "7th row should be a group"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_container .o_gantt_row:nth(9) .o_gantt_row_title")
            .text()
            .trim(),
          "User 2",
          '7th row title should be "User 2"'
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(6) .o_gantt_consolidated_pill_title")
            .text()
            .replace(/\s+/g, ""),
          "301103060",
          "the consolidation should be correctly computed"
        ...
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(6) .o_gantt_pill:eq(0)")
            .css("background-color"),
          "rgb(40, 167, 69)",
          "the 1st group pill should have the correct color)"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(6) .o_gantt_pill:eq(1)")
            .css("background-color"),
          "rgb(220, 53, 69)",
          "the 2nd group pill should have the correct color)"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(6) .o_gantt_pill:eq(2)")
            .css("background-color"),
          "rgb(40, 167, 69)",
          "the 3rd group pill should have the correct color"
        );
        assert.strictEqual(
          gantt
            .$(".o_gantt_row_group:eq(6) .o_gantt_pill:eq(3)")
            .css("background-color"),
          "rgb(40, 167, 69)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(6) .o_gantt_pill_wrapper:eq(0)")
          ),
          "calc(300% + 2px - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(6) .o_gantt_pill_wrapper:eq(1)")
          ),
          "calc(50% - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(6) .o_gantt_pill_wrapper:eq(2)")
          ),
          "calc(150% - 0px)",
        ...
        assert.strictEqual(
          getPillItemWidth(
            gantt.$(".o_gantt_row_group:eq(6) .o_gantt_pill_wrapper:eq(3)")
          ),
          "calc(500% + 4px - 0px)",
      ...
      QUnit.test("color attribute on a many2one", async function (assert) {
        ...
        assert.containsN(
          gantt,
          ".o_gantt_pill.o_gantt_color_1",
          4,
          "there should be 4 pills with color 1"
        );
        assert.containsN(
          gantt,
          ".o_gantt_pill.o_gantt_color_2",
          2,
      ...
      QUnit.test(
        'Today style with unavailabilities ("week": "day:half")',
        async function (assert) {
          assert.expect(2);
          ...
          const cell4 = gantt.el.querySelectorAll(
            ".o_gantt_row_container .o_gantt_cell"
          )[3];
      ...
      QUnit.test("Today style of group rows", async function (assert) {
        ...
        assert.deepEqual(
          [...todayCells].map((c) => c.getAttribute("style")),
          [
            null,
        ...
        assert.strictEqual(
          window.getComputedStyle(todayCells[1]).getPropertyValue("background-color"),
          "rgba(0, 0, 0, 0)"
        );
      ...
      QUnit.test('Unavailabilities ("month": "day:half")', async function (assert) {
        ...
        assert.hasAttrValue(
          cell5,
          "style",
          "height: 105px; background: linear-gradient(90deg, #fffaeb 49%, #e9ecef 50%);"
        );
        const cell6 = cells[5];
        ...
        assert.hasAttrValue(
          cell16,
          "style",
          "height: 105px; background: linear-gradient(90deg, #ffffff 49%, #e9ecef 50%);"
        );
        ...
        assert.hasAttrValue(
          cell18,
          "style",
          "height: 105px; background: linear-gradient(90deg, #e9ecef 49%, #ffffff 50%);"
        );
      ...
      QUnit.test('Unavailabilities ("day": "hours:quarter")', async function (assert) {
        ...
        assert.hasAttrValue(
          cell9,
          "style",
          "height: 0px; background: linear-gradient(90deg, #ffffff 24%, #e9ecef 25%, #e9ecef 49%, #ffffff 50%, #ffffff 74%, #ffffff 75%);"
        );
        const cell11 = cells[10];
        assert.hasAttrValue(
          cell11,
          "style",
          "height: 0px; background: linear-gradient(90deg, #ffffff 24%, #ffffff 25%, #ffffff 49%, #ffffff 50%, #ffffff 74%, #e9ecef 75%);"
        );
        ...
        assert.hasAttrValue(
          cell13,
          "style",
          "height: 0px; background: linear-gradient(90deg, #e9ecef 24%, #ffffff 25%, #ffffff 49%, #ffffff 50%, #ffffff 74%, #ffffff 75%);"
        );
        const cell21 = cells[20];
        assert.hasAttrValue(
          cell21,
          "style",
          "height: 0px; background: linear-gradient(90deg, #ffffff 24%, #e9ecef 25%, #e9ecef 49%, #e9ecef 50%, #e9ecef 74%, #ffffff 75%);"
        );
      ...
      QUnit.test("offset attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" offset="-4" default_scale="day"/>',
          viewOptions: {
            initialDate: initialDate,
          },
        });
      ...
      QUnit.test("default_group_by attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" default_group_by="user_id" />',
          viewOptions: {
            initialDate: initialDate,
          },
        });

        assert.containsN(gantt, ".o_gantt_row", 2, "there should be 2 rows");
        assert.strictEqual(
          gantt.$(".o_gantt_row:last .o_gantt_row_title").text().trim(),
          "User 2",
      ...
      QUnit.test("dynamic_range attribute", async function (assert) {
        ...
        var gantt = await createView({
          ...
          data: this.data,
          arch:
            '<gantt date_start="start" date_stop="stop" default_group_by="user_id" dynamic_range="1" default_scale="month"/>',
          viewOptions: {
            initialDate: initialDate,
          },
        });
      ...
      QUnit.test(
        "collapse_first_level attribute with single-level grouped",
        async function (assert) {
          assert.expect(13);
          ...
          var gantt = await createView({
            ...
            data: this.data,
            arch:
              '<gantt string="Tasks" date_start="start" date_stop="stop" collapse_first_level="1" />',
            archs: {
              "tasks,false,form":
                "<form>" +
                '<field name="name"/>' +
          ...
          assert.containsN(
            gantt,
            ".o_gantt_row_container .o_gantt_row.o_gantt_row_group",
            2,
            "should have 2 group rows"
          );
          assert.strictEqual(
            gantt.$(".o_gantt_row_group:eq(0) .o_gantt_row_title").text().trim(),
            "Project 1",
            'should contain "Project 1" in sidebar title'
          );
          assert.containsN(
            gantt,
            ".o_gantt_row:eq(1) .o_gantt_pill",
            4,
            "should have a 4 pills in first row"
          );
          assert.strictEqual(
            gantt.$(".o_gantt_row_group:eq(1) .o_gantt_row_title").text().trim(),
            "Project 2",
            'should contain "Project 2" in sidebar title'
          );
          assert.containsN(
            gantt,
            ".o_gantt_row:eq(3) .o_gantt_pill",
            2,
          ...
          await testUtils.dom.triggerMouseEvent(
            gantt.$(
              '.o_gantt_row:nth(3) .o_gantt_cell[data-date="2018-12-10 00:00:00"] .o_gantt_cell_add'
            ),
            "click"
          );
          await testUtils.nextTick();
          ...
          assert.strictEqual(
            $(".modal .o_field_widget[name=project_id] .o_input").val(),
            "Project 2",
      ...
      // CONCURRENCY TESTS
      QUnit.test("concurrent scale switches return in inverse order", async function (
        assert
      ) {
        assert.expect(11);
        ...
        assert.strictEqual(
          gantt.model.get().records.length,
          6,
      ...
      QUnit.test("concurrent pill resizes return in inverse order", async function (
        assert
      ) {
        assert.expect(7);
      ...
      QUnit.test(
        "concurrent pill resizes and open, dialog show updated number",
        async function (assert) {
          assert.expect(1);
          ...
          await testUtils.nextTick();
          assert.strictEqual(
            $(".modal").find("input[name=stop]").val(),
            "12/24/2018 06:29:59"
          );
      ...
      QUnit.test("dst spring forward", async function (assert) {
        ...
        var firstStartDateLocalString = firstStartDateUTC
          .local()
          .format("YYYY-MM-DD hh:mm:ss");
        this.data.tasks.records.push({
          id: 99,
        ...
        var secondStartDateLocalString = secondStartDateUTC
          .local()
          .format("YYYY-MM-DD hh:mm:ss");
        this.data.tasks.records.push({
          id: 100,
        ...
        assert.containsOnce(
          gantt,
          '.o_gantt_row_container .o_gantt_cell[data-date="' +
            firstStartDateLocalString +
            '"] .o_gantt_pill_wrapper:contains(DST Task 1)',
        ...
        assert.containsOnce(
          gantt,
          '.o_gantt_row_container .o_gantt_cell[data-date="' +
            secondStartDateLocalString +
            '"] .o_gantt_pill_wrapper:contains(DST Task 2)',
          "should be in the right cell"
        );
      ...
      QUnit.skip(
        "[for manual testing] scripting time of large amount of records (ungrouped)",
        async function (assert) {
          assert.expect(1);
      ...
      QUnit.skip(
        "[for manual testing] scripting time of large amount of records (one level grouped)",
        async function (assert) {
          assert.expect(1);
      ...
      QUnit.skip(
        "[for manual testing] scripting time of large amount of records (two level grouped)",
        async function (assert) {
          assert.expect(1);
      ...
      QUnit.test("delete attribute on dialog", async function (assert) {
        ...
        await testUtils.dom.triggerMouseEvent(
          gantt.$(
            '.o_gantt_row_container .o_gantt_row .o_gantt_cell[data-date="2018-12-17 00:00:00"] .o_gantt_pill'
          ),
          "click"
        );
        await testUtils.nextTick();
      ...
      QUnit.test(
        ...
        async function (assert) {
          ...
          await testUtils.dom.click(
            gantt.$(".o_gantt_row_container > .o_gantt_row:first .o_gantt_row_title")
          );
          assert.doesNotHaveClass(
            gantt.$(".o_gantt_row_container > .o_gantt_row:first"),
            "open",
      ...
      QUnit.test(
        ...
        async function (assert) {
          ...
          assert.verifySteps([
            "start,<=,2018-12-31 23:59:59,stop,>=,2018-12-01 00:00:00",
          ]);

          await testUtils.dom.triggerMouseEvent(
            $(webClient.el).find(".o_gantt_cell_plan:first"),
            "click"
          );
          await nextTick();
          ...
          assert.verifySteps([
            "project_id,=,1,start,<=,2018-12-31 23:59:59,stop,>=,2018-12-01 00:00:00",
          ]);
