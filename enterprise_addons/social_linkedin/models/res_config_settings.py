...
class ResConfigSettings(models.TransientModel):
    ...
    linkedin_use_own_account = fields.Boolean(
    ...
    linkedin_app_id = fields.Char(
        "App ID",
        config_parameter="social.linkedin_app_id",
        compute="_compute_linkedin_app_id",
        inverse="_inverse_linkedin_app_id",
    )
    linkedin_client_secret = fields.Char(
        "App Secret",
        config_parameter="social.linkedin_client_secret",
    ...
    def _compute_linkedin_client_secret(self):
        ...
        for setting in self:
            setting.linkedin_client_secret = (
                linkedin_client_secret if user_is_manager else None
            )
    ...
    def _inverse_linkedin_client_secret(self):
        ...
        for setting in self:
            if user_is_manager:
                self.env["ir.config_parameter"].sudo().set_param(
                    "social.linkedin_client_secret", setting.linkedin_client_secret
                )
