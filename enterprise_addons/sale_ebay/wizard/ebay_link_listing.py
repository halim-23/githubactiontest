...
class ebay_link_listing(models.TransientModel):
    ...
    def _link_listing(self):
        response = self.env["product.template"].ebay_execute(
            "GetItem", {"ItemID": self.ebay_id, "DetailLevel": "ReturnAll"}
        )
        ...
        product_values = {
            ...
            "ebay_item_condition_id": self.env["ebay.item.condition"]
            .search([("code", "=", item["ConditionID"])])
            .id
            if "ConditionID" in item
            else False,
            "ebay_category_id": self.env["ebay.category"]
            .search(
                [
            ...
            .id,
            "ebay_store_category_id": self.env["ebay.category"]
            .search(
                [
            ...
            "ebay_store_category_2_id": self.env["ebay.category"]
            .search(
                [
            ...
            "ebay_best_offer": True
            if "BestOfferDetails" in item
            and item["BestOfferDetails"]["BestOfferEnabled"] == "true"
            else False,
        ...
        if "SellerProfiles" in item:
            if (
                "SellerPaymentProfile" in item["SellerProfiles"]
                ...
                if ebay_seller_payment_policy_id:
                    ...
                    ] = ebay_seller_payment_policy_id[0]["id"]
            if (
                "SellerReturnProfile" in item["SellerProfiles"]
                ...
                if ebay_seller_return_policy_id:
                    ...
                    ] = ebay_seller_return_policy_id[0]["id"]
            if (
                "SellerShippingProfile" in item["SellerProfiles"]
                and "ShippingProfileID"
                in item["SellerProfiles"]["SellerShippingProfile"]
            ):
                ...
                if ebay_seller_shipping_policy_id:
                    ...
                    ] = ebay_seller_shipping_policy_id[0]["id"]
        ...
        if "Variations" in item:
            ...
            for variation in variations:
                ...
                variant.write(
                    {
                        "ebay_use": True,
                        "ebay_quantity_sold": variation["SellingStatus"][
                            "QuantitySold"
                        ],
                        ...
                        "ebay_quantity": int(variation["Quantity"])
                        - int(variation["SellingStatus"]["QuantitySold"]),
                    }
                )
            ...
            product.product_variant_ids.write(
                {
                    ...
                    "ebay_quantity": int(item["Quantity"])
                    - int(item["SellingStatus"]["QuantitySold"]),
                }
            )
