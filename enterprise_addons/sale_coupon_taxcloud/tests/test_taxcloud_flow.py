...
class TestSaleCouponTaxCloudFlow(common.TestSaleCouponTaxCloudCommon):
    def setUp(self):
        ...
        patchers = [
            ...
            patch(
                "odoo.addons.account_taxcloud.models.taxcloud_request.TaxCloudRequest.verify_address",
                self._verify_address,
            ),
            patch(
                "odoo.addons.account_taxcloud.models.taxcloud_request.TaxCloudRequest.get_all_taxes_values",
    ...
    def test_flow(self):
        ...
        self.assertEqual(
            discount_line.coupon_program_id,
