...
class Company(models.Model):
    ...
    planning_generation_interval = fields.Integer(
        "Rate Of Shift Generation",
        required=True,
        readonly=False,
        default=6,
        help="Delay for the rate at which recurring shift should be generated in month",
    )
    ...
    _sql_constraints = [
        (
            "planning_self_unassign_days_before_positive",
