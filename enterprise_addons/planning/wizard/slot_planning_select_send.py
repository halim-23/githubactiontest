...
class SlotPlanningSelectSend(models.TransientModel):
    ...
    def default_get(self, default_fields):
        ...
        if (
            "employee_ids" in default_fields
            and res.get("slot_id")
            and "employee_ids" not in res
        ):
                    ...
                    domain = expression.AND(
                        [
                            ...
                            [
                                ...
                                ("planning_role_ids", "in", slot.role_id.id),
                            ],
                        ]
                    )
    ...
    def action_send(self):
        ...
        return self.slot_id._send_slot(
            self.employee_ids, self.slot_id.start_datetime, self.slot_id.end_datetime
        )
