...
tour.register(
  ...
  [
    ...
    },
    {
      ...
      content:
        "Let's create your first <b>shift</b> by clicking on Add. <i>Tip: use the (+) shortcut available on each cell of the Gantt view to save time.</i>",
    },
    {
      trigger: ".o_field_widget[name='resource_id']",
      content:
        "Assign this shift to your <b>resource</b>, or leave it open for the moment.",
    },
    {
      trigger: ".o_field_widget[name='role_id']",
      content:
        "Select the <b>role</b> your employee will have (<i>e.g. Chef, Bartender, Waiter, etc.</i>).",
    },
    {
    ...
    },
    {
      ...
      content:
        "<b>Drag & drop</b> your shift to reschedule it. <i>Tip: hit CTRL (or Cmd) to duplicate it instead.</i> <b>Adjust the size</b> of the shift to modify its period.",
      run: function () {
        if (this.$anchor.length) {
          ...
          if (!actual.startsWith(expected)) {
            console.error(
              "Test in gantt view doesn't start as expected. Expected : '" +
                expected +
                "', actual : '" +
                actual +
                "'"
    ...
    },
    {
      ...
      content:
        "If you are happy with your planning, you can now <b>send</b> it to your employees.",
    },
    {
      trigger: "button[name='action_send']",
      content:
        "<b>Publish & send</b> your planning to make it available to your employees.",
    },
    {
