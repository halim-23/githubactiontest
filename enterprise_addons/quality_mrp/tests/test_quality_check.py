...
class TestQualityCheck(TestQualityMrpCommon):
    def test_00_production_quality_check(self):
        ...
        details_operation_form = Form(
            self.mrp_production_qc_test1.move_raw_ids[0],
    ...
    def test_01_production_quality_check_product(self):
        ...
        self.assertEqual(
            production.move_finished_ids.move_line_ids.check_ids[0].qty_to_test, 2
        )
    ...
    def test_01_quality_check_scrapped(self):
        ...
        qc = self.env["quality.check"].search(
            [("product_id", "=", product.id), ("point_id", "=", qp.id)]
        )
        qc.unlink()
        ...
        scrap = (
            ...
            .with_context(active_model="mrp.production", active_id=mo.id)
            .create(
                {
        ...
        self.assertEqual(
            ...
            0,
            "Quality checks should not be created for scrap moves",
        )
