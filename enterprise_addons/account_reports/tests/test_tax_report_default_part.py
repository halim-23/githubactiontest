...
class TestTaxReportDefaultPart(TestAccountReportsCommon):
    ...
    def checkAmlsRedirection(self, report, options, tax, expected_amls):
        action = report._redirect_audit_default_tax_report(
            options, tax.type_tax_use, tax.id
        )
    ...
    def test_tax_affect_base(self):
        ...
        options = self._init_options(
            ...
            fields.Date.from_string("2019-01-31"),
        )
    ...
    def test_affect_base_with_repetitions(self):
        ...
        report_options = self._init_options(
            report, move.date, move.date, {"tax_report": "generic"}
        )
        self.assertLinesValues(
    ...
    def test_tax_invoice_completely_refund(self):
        ...
        expected_amls = (invoice + refund).line_ids.filtered(
