...
class TestAccountReportsCommon(AccountTestInvoicingCommon):
    ...
    def _update_comparison_filter(
        ...
        :return:                The newly created options.
        """
        report._init_filter_comparison(
            options,
            {
                **options,
                "comparison": {
    ...
    def _create_tax_report_line(
        ...
        code=None,
        formula=None,
        carry_over_condition=None,
        is_carryover_used_in_balance=False,
        carry_over_destination_line_id=False,
        is_carryover_persistent=True,
    ):
