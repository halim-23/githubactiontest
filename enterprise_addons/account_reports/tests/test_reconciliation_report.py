...
class TestReconciliationReport(TestAccountReportsCommon):
    ...
    def test_reconciliation_report_single_currency(self):
        ...
        payment_line = payment_1.line_ids.filtered(
            lambda line: line.account_id
            == bank_journal.company_id.account_journal_payment_debit_account_id
        )
        ...
        payment_line = payment_2.line_ids.filtered(
            lambda line: line.account_id
            == bank_journal.company_id.account_journal_payment_credit_account_id
        )
        st_line.reconcile([{"id": payment_line.id}])

        # ==== Report ====

        report = self.env["account.bank.reconciliation.report"].with_context(
        ...
        with freeze_time("2016-01-02"):
            ...
            self.assertLinesValues(
                ...
                [
                    ...
                    (
                        "Total Including Unreconciled Bank Statement Payments",
                        "",
                        -900.0,
                    ),
        ...
        with freeze_time("2016-01-02"), self.debug_mode(report):
            ...
            self.assertLinesValues(
                ...
                [
                    ...
                    (
                        "Including Unreconciled Bank Statement Receipts",
                        "",
                        "",
                        "",
                        200.0,
                    ...
                    (
                        "Total Including Unreconciled Bank Statement Receipts",
                        "",
                        "",
                        "",
                        200.0,
        ...
        statement = self.env["account.bank.statement"].create(
            {
                ...
                "line_ids": [
                    (
                        0,
                        0,
                        {"payment_ref": "line_1", "amount": 10.0, "date": "2019-01-01"},
                    ),
                    (
                        0,
                        0,
                        {"payment_ref": "line_2", "amount": 20.0, "date": "2019-01-02"},
                    ),
                    (
                        0,
                        0,
                        {"payment_ref": "line_3", "amount": 30.0, "date": "2019-01-03"},
                    ),
                    (
                        0,
                        0,
                    ...
                    (
                        0,
                        0,
                        {"payment_ref": "line_5", "amount": 50.0, "date": "2019-01-05"},
                    ),
                    (
                        0,
                        0,
                        {"payment_ref": "line_6", "amount": 60.0, "date": "2019-01-06"},
                    ),
                ],
            }
        )
