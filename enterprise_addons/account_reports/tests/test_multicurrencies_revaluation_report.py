...
class TestMultiCurrenciesRevaluationReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.receivable_account_2 = cls.copy_account(
    ...
    def test_same_currency(self):
        ...
        (payment_move + self.receivable_move).line_ids.filtered(
            lambda line: line.account_id == self.receivable_account_1
        ).reconcile()
        ...
        wizard.expense_provision_account_id = self.company_data[
            "default_account_expense"
        ]
        wizard.income_provision_account_id = self.company_data[
            "default_account_revenue"
        ]
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {
                    "account_id": wizard.expense_provision_account_id.id,
                    "debit": 50,
                    "credit": 0,
                },
                {"account_id": self.receivable_account_2.id, "debit": 50, "credit": 0},
                {
                    "account_id": wizard.income_provision_account_id.id,
                    "debit": 0,
                    "credit": 50,
                },
            ],
