...
class TestCashFlowReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.account_no_tag = cls.receivable_account_1.copy(
            default={"user_type_id": current_assets_type.id, "reconcile": True}
        )
        cls.account_no_tag.name = "account_no_tag"
        cls.account_financing = cls.receivable_account_1.copy(
            default={"user_type_id": current_assets_type.id, "reconcile": True}
        )
        cls.account_financing.name = "account_financing"
        cls.account_financing.tag_ids |= cls.env.ref("account.account_tag_financing")
        cls.account_operating = cls.receivable_account_1.copy(
            default={"user_type_id": current_assets_type.id, "reconcile": True}
        )
    ...
    def assertCashFlowValues(self, report, options, expected_lines):
        ...
        for line in lines:
            self.assertNotEqual(
                line["id"],
                "cash_flow_line_unexplained_difference",
                "Test failed due to an unexplained difference in the report.",
            )
    ...
    def test_cash_flow_multi_currency_unfolding(self):
        ...
        self._reconcile_on(
            ...
            self.company_data_2["default_account_receivable"],
        )
    ...
    def test_cash_flow_tricky_case_2(self):
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 0.0,
                            "credit": 250.0,
                            "account_id": self.receivable_account_3.id,
                        },
                    ),
                    (
                        0,
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 0.0,
                            "credit": 3000.0,
                            "account_id": self.receivable_account_2.id,
                        },
                    ),
                ],
            }
        ...
        self._reconcile_on(
            (misc_move + liquidity_move_1).line_ids, self.receivable_account_1
        )
        ...
        self._reconcile_on(
            (misc_move + liquidity_move_2).line_ids, self.receivable_account_2
        )
        ...
        self._reconcile_on(
            (liquidity_move_1 + liquidity_move_2).line_ids, self.receivable_account_3
        )
