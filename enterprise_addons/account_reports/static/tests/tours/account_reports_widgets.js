  ...
  tour.register(
    ...
    [
      ...
      },
      {
        ...
        trigger:
          "[data-parent-id] .o_account_report_line .o_account_reports_domain_dropdown:first .js_account_reports_add_footnote",
        run: "click",
      },
      {
      ...
      },
      {
        content: "change date filter",
        trigger:
          ".dropdown-item.js_account_report_date_filter[data-filter='last_year']",
        run: "click",
      },
      {
        content: "wait refresh",
        trigger:
          ".o_account_reports_level2:last() .o_account_report_column_value:contains(0.00)",
      },
      {
      ...
      },
      {
        content: "change comparison filter",
        trigger:
          ".dropdown-item.js_foldable_trigger[data-filter='previous_period_filter']",
      },
      {
        content: "change comparison filter",
