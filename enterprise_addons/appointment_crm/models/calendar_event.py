...
class CalendarEventCrm(models.Model):
    ...
    def create(self, vals_list):
        ...
        events.filtered(
            lambda e: e.appointment_type_id.lead_create
            and e.partner_ids - e.user_id.partner_id
    ...
    def _get_lead_values(self, partner):
        appointment_tag = self.env.ref(
            "appointment_crm.appointment_crm_tag", raise_if_not_found=False
        )
        return {
            "name": self.name,
