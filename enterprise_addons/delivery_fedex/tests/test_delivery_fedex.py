...
ERROR_200 = "200: Rating is temporarily unavailable, please try again later."
ERROR_200_BIS = "200: An unexpected exception occurred"
ERROR_200_TER = "200: An unexpected exception occurred, not found"
ERROR_1000 = "1000: General Failure"
SKIPPABLE_ERRORS = [ERROR_200, ERROR_200_BIS, ERROR_200_TER, ERROR_1000]
SKIP_MSG = "Test skipped due to FedEx server unavailability"
    ...
    def test_01_fedex_basic_us_domestic_flow(self):
        try:
                ...
                self.env["choose.delivery.carrier"].with_context(
                    {
                        ...
                        "default_carrier_id": self.env.ref(
                            "delivery_fedex.delivery_carrier_fedex_us"
                        ).id,
                    }
                )
            )
            ...
            self.assertGreater(
                ...
                0.0,
                "FedEx delivery cost for this SO has not been correctly estimated.",
            )
            ...
            self.assertIsNot(
                ...
                False,
                "FedEx did not return any tracking number",
            )
            self.assertGreater(
                picking.carrier_price, 0.0, "FedEx carrying price is probably incorrect"
            )
            ...
            self.assertEqual(
                ...
                0.0,
                "Carrier price has not been properly deleted",
            )
                ...
                self.env["choose.delivery.carrier"].with_context(
                    {
                        "default_order_id": sale_order.id,
                        "default_carrier_id": self.env.ref(
                            "delivery_fedex.delivery_carrier_fedex_inter"
                        ).id,
                    }
                )
            )
