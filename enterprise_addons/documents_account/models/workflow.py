        ...
        if self.create_model.startswith("account.move"):
            ...
            for document in documents:
                ...
                if document.res_model == "account.move" and document.res_id:
                    ...
                    new_obj.partner_bank_id = (
                        new_obj.bank_partner_id.bank_ids
                        and new_obj.bank_partner_id.bank_ids[0]
                    )
                    ...
                    new_obj.with_context(
                        default_journal_id=journal.id, default_move_type=invoice_type
