odoo.define("pos_hr_l10n_be.pos_hr_l10n_be", function (require) {
  ...
  models.PosModel = models.PosModel.extend({
    check_if_user_clocked: function () {
      ...
      return this.pos_session.employees_clocked_ids.find(function (elem) {
        return elem === employee_id;
      });
    },
  ...
  models.load_models(
    {
      ...
      order: _.map(["date_order"], function (name) {
  ...
  models.load_models(
    {
      ...
      domain: [
        "|",
        ["name", "=", "product_product_work_in"],
        ["name", "=", "product_product_work_out"],
      ],
      fields: ["name", "res_id"],
      loaded: function (self, params) {
