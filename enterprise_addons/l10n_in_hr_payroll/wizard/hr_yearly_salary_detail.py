...
class YearlySalaryDetail(models.TransientModel):
    ...
    date_from = fields.Date(
        string="Start Date", required=True, default=_get_default_date_from
    )
    date_to = fields.Date(
        string="End Date", required=True, default=_get_default_date_to
    )
    ...
    def print_report(self):
        ...
        return self.env.ref(
            "l10n_in_hr_payroll.action_report_hryearlysalary"
