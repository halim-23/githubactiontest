...
class TestForecastCreationAndEditing(TestCommonForecast):
    ...
    def test_creating_a_planning_shift_allocated_hours_are_correct(self):
        values = {
            ...
            "start_datetime": datetime(
                2019, 6, 6, 8, 0, 0
            ),  # 6/6/2019 is a tuesday, so a working day
        ...
        self.assertEqual(
            planning_shift.allocated_hours,
            9.0,
            "resource hours should be a full workday",
        )
        ...
        self.assertEqual(
            planning_shift.allocated_hours,
            4.5,
            "resource hours should be a half duration",
        )
        ...
        values = {
            ...
            "end_datetime": datetime(
                2019, 6, 2, 17, 0, 0
            ),  # sunday evening, same sunday, so employee is not working
        }
        ...
        self.assertEqual(
            planning_shift.allocated_hours,
            9,
            "resource hours should be a full day working hours",
        )
        ...
        values = {
            ...
            "end_datetime": datetime(
                2019, 6, 8, 23, 59, 0
            ),  # 6/8/2019 is a sunday, so we have a full week
        }
        planning_shift.write(values)
        ...
        self.assertEqual(
            planning_shift.allocated_hours,
            40,
            "resource hours should be a full week's available hours",
        )
    ...
    def test_task_in_project(self):
        ...
        self.assertEqual(
            ...
            "If we put a task when creation, we take the project of this task for this new slot.",
        )
        ...
        self.assertEqual(
            slot.project_id,
            self.project_opera,
            "If the project changed in the task linked to this shift, the new project of this task must be the project linked to this shift.",
        )
        ...
        self.assertEqual(
            slot.task_id,
            shift_template.task_id,
            "the task should be the same of its template.",
        )
        self.assertEqual(
            slot.task_id,
            self.task_opera_place_new_chairs,
            "The task of the slot should be the one in the template.",
        )
        self.assertEqual(
            slot.project_id,
            shift_template.project_id,
            "the project should be the same of its template.",
        )
        self.assertEqual(
            slot.project_id,
            self.project_opera,
            "The project of the slot should be the one in the template.",
        )
        ...
        self.assertEqual(
            slot.project_id,
            self.project_horizon,
            "The project of the slot should be the new one of the task.",
        )
