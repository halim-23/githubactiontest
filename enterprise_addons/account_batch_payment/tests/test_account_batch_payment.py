...
class TestAccountBatchPayment(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.payment_debit_account_id = cls.copy_account(
            company_id.account_journal_payment_debit_account_id
        )
        cls.payment_credit_account_id = cls.copy_account(
            company_id.account_journal_payment_credit_account_id
        )
    ...
    def test_create_batch_payment_from_payment(self):
        ...
        batch_payment_id = self.env["account.batch.payment"].browse(
