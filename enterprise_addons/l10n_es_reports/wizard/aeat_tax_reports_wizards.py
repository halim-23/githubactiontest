...
class Mod303Wizard(models.TransientModel):
    ...
    casilla_43 = fields.Monetary(
        string="[43] Regularización bienes de inversión", default=0
    )
    casilla_44 = fields.Monetary(
        string="[44] Regularización por aplicación del porcentaje definitivo de prorrata",
        default=0,
    )
