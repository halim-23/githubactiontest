...
class ResCompany(models.Model):
    ...
    def balance_sheet_menu_item_clicked(self):
        ...
        spanish_coa_bs_map = {
            self.env.ref("l10n_es.account_chart_template_pymes"): self.env.ref(
                "l10n_es_reports.financial_report_balance_sheet_pymes"
            ).id,
            self.env.ref("l10n_es.account_chart_template_full"): self.env.ref(
                "l10n_es_reports.financial_report_balance_sheet_full"
            ).id,
            self.env.ref("l10n_es.account_chart_template_assoc"): self.env.ref(
        ...
        return {
            ...
            "context": {
                ...
                "id": spanish_coa_bs_map.get(
                    current_company.chart_template_id, default_bs
                ),
            },
        }
    ...
    def open_aeat_tax_report(self, modelo):
        ...
        return {
            ...
            "view_id": self.env.ref(
                "l10n_es_reports.mod" + modelo + "_report_wizard"
            ).id,
