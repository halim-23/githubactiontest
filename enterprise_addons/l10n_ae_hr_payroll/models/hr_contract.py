...
class HRContract(models.Model):
    ...
    _sql_constraints = [
        (
            "l10n_ae_hr_payroll_number_of_days_constraint",
            "CHECK(l10n_ae_number_of_days >= 0)",
