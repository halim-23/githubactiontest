      ...
      loaded: function (self, iot_devices) {
        ...
        _.each(iot_devices, function (iot_device) {
          ...
          switch (iot_device.type) {
            case "scale":
              self.iot_device_proxies[iot_device.type] = new DeviceProxy(self, {
                iot_ip: iot_device.iot_ip,
                identifier: iot_device.identifier,
                manual_measurement: iot_device.manual_measurement,
              });
              break;
            ...
            case "display":
              ...
              break;
            case "printer":
              self.iot_device_proxies[iot_device.type] = new PrinterProxy(self, {
                iot_ip: iot_device.iot_ip,
                identifier: iot_device.identifier,
              });
              break;
            ...
            case "payment":
              _.each(self.payment_methods, function (payment_method) {
                if (payment_method.iot_device_id[0] == iot_device.id) {
                  payment_method.terminal_proxy = new DeviceProxy(self, {
                    iot_ip: iot_device.iot_ip,
                    identifier: iot_device.identifier,
                    manufacturer: iot_device.manufacturer,
                  });
                }
              });
              break;
