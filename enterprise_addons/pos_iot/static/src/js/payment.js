  ...
  var PaymentIOT = PaymentInterface.extend({
    ...
    send_payment_request: function (cid) {
      ...
      return new Promise(function (resolve) {
        ...
        self
          .get_terminal()
          .add_listener(self._onValueChange.bind(self, resolve, self.pos.get_order()));
    ...
    _onValueChange: function (resolve, order, data) {
      ...
      var terminal_proxy = this.pos.payment_methods_by_id[line.payment_method.id]
        .terminal_proxy;
      if (
        line &&
        terminal_proxy &&
        (!data.owner ||
          data.owner === this.pos.env.services.iot_longpolling._session_id)
      ) {
