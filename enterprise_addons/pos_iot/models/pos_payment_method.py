...
class PoSPaymentMethod(models.Model):
    ...
    payment_terminal_ids = fields.Many2many(
        "iot.device", compute="_compute_payment_terminal_ids"
    )
    ...
    def _get_payment_terminal_selection(self):
        ...
        if (
            ...
            .sudo()
            .get_param("pos_iot.ingenico_payment_terminal")
        ):
            selection_list.append(("ingenico", "Ingenico"))
        elif (
            self.env["ir.config_parameter"]
            .sudo()
            .get_param("pos_iot.worldline_payment_terminal")
        ):
