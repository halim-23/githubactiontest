odoo.define("sale_industry_fsm.tour", function (require) {
  ...
  var fsmStartStepIndex = _.findIndex(tour.tours.industry_fsm_tour.steps, function (
    step
  ) {
    return step.id === "fsm_start";
  });

  tour.tours.industry_fsm_tour.steps.splice(
    fsmStartStepIndex + 1,
    0,
    {
    ...
    },
    {
      ...
      content: Markup(
        _t(
          "Choose a <b>name</b> for your product <i>(e.g. Bolts, Screws, Boiler, etc.).</i>"
        )
      ),
      position: "right",
    },
    ...
    },
    {
      ...
      content: Markup(
        _t("Use the breadcrumbs to go back to your <b>list of products</b>.")
      ),
      position: "bottom",
    },
    {
      ...
      content: _t(
        "Click on your product to add it to your <b>list of materials</b>. <i>Tip: for large quantities, click on the number to edit it directly.</i>"
      ),
      position: "right",
    },
    {
  ...
  var fsmCreateInvoiceStepIndex = _.findIndex(
    tour.tours.industry_fsm_tour.steps,
    function (step) {
