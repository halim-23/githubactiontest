...
class WebsiteAppointmentTest(common.TransactionCase):
    ...
    def test_is_published_custom_appointment_type(self):
        ...
        self.assertTrue(
            custom_appointment.is_published,
            "A custom appointment type should be auto published at creation",
        )
    ...
    def test_is_published_website_appointment_type(self):
        ...
        self.assertFalse(
            website_appointment.is_published,
            "A website appointment type should not be published at creation",
        )
        ...
        self.assertFalse(
            appointment_copied.is_published,
            "The appointment copied should still be unpublished even if the later was published",
        )
    ...
    def test_is_published_work_hours_appointment_type(self):
        ...
        self.assertTrue(
            work_hours_appointment.is_published,
            "A custom appointment type should be published at creation",
        )
    ...
    def test_is_published_write_appointment_type_category(self):
        ...
        self.assertTrue(
            appointment.is_published,
            "Modifying an appointment type category to custom auto-published it",
        )

        appointment.write({"category": "website"})
        self.assertFalse(
            appointment.is_published,
            "Modifying an appointment type category to website unpublished it",
        )

        appointment.write({"category": "work_hours"})
        self.assertTrue(
            appointment.is_published,
            "Modifying an appointment type category to work_hours auto-published it",
        )
