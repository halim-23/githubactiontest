...
class TestPayrollCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.env = cls.env(
            context=dict(cls.env.context, allowed_company_ids=cls.belgian_company.ids)
        )
    ...
    def setUp(self):
        ...
        self.georges_contracts.write(
            {"state": "close"}
        )  # By default, the state is 'draft' when we create a new contract
