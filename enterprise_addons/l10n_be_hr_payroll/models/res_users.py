...
class User(models.Model):
    ...
    spouse_fiscal_status = fields.Selection(
        related="employee_ids.spouse_fiscal_status", readonly=False
    )
    spouse_fiscal_status_explanation = fields.Char(
        related="employee_ids.spouse_fiscal_status_explanation"
    )
    disabled = fields.Boolean(related="employee_ids.disabled", readonly=False)
    disabled_spouse_bool = fields.Boolean(
        related="employee_ids.disabled_spouse_bool", readonly=False
    )
    disabled_children_bool = fields.Boolean(
        related="employee_ids.disabled_children_bool", readonly=False
    )
    resident_bool = fields.Boolean(related="employee_ids.resident_bool", readonly=False)
    disabled_children_number = fields.Integer(
        related="employee_ids.disabled_children_number", readonly=False
    )
    dependent_children = fields.Integer(
        related="employee_ids.dependent_children", readonly=False
    )
    other_dependent_people = fields.Boolean(
        related="employee_ids.other_dependent_people", readonly=False
    )
    other_senior_dependent = fields.Integer(
        related="employee_ids.other_senior_dependent", readonly=False
    )
    other_disabled_senior_dependent = fields.Integer(
        related="employee_ids.other_disabled_senior_dependent", readonly=False
    )
    other_juniors_dependent = fields.Integer(
        related="employee_ids.other_juniors_dependent", readonly=False
    )
    other_disabled_juniors_dependent = fields.Integer(
        related="employee_ids.other_disabled_juniors_dependent", readonly=False
    )
    dependent_seniors = fields.Integer(
        related="employee_ids.dependent_seniors", readonly=False
    )
    dependent_juniors = fields.Integer(
        related="employee_ids.dependent_juniors", readonly=False
    )
