...
class TestReadGridDomainDate(TestWebGrid):
    ...
    def test_read_grid_method_date(self):
        ...
        result_read_grid = self.grid_obj_2.with_context(
            grid_anchor="2019-06-14"
        ).read_grid(row_field, col_field, cell_field, domain, grid_range)
        ...
        self.assertEqual(
            result_read_grid.get("initial").get("grid_anchor"), Date.to_string(today)
        )
        ...
        self.assertEqual(
            result_read_grid_readonly.get("grid")[0][date_of_work].get("readonly"), True
        )
        ...
        self.assertEqual(
            result_read_grid.get("grid")[0][1].get("value"),
            self.grid_obj_2.resource_hours,
        )  # resource_hours for grid_obj_2 is 4.0
