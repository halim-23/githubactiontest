  ...
  class PdfManager extends owl.Component {
    ...
    async _applyChanges(ruleId) {
      ...
      if (processedPageIds.length === 0) {
        this.trigger("pdf-manager-error", {
          message: _t("No document has been selected"),
        });
        return;
      }
     ...
     * @returns {Object} { pageIds, newPages }
     * @returns {Array<String>} pageIds
     * @returns {Object} newPages
     */
