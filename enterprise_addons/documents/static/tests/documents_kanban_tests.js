odoo.define("documents.documents_kanban_tests", function (require) {
  ...
  const {afterEach, afterNextRender, beforeEach} = require("@mail/utils/test_utils");
    ...
    QUnit.module(
          ...
          Object.assign(this.data, {
            "documents.document": {
              fields: {
                ...
                is_editable_attachment: {
                  string: "Is Editable Attachment",
                  type: "boolean",
                },
              },
              records: [
              ...
              records: [
                {
                  ...
                  limited_to_single_record: false,
                },
                {
                  id: 2,
                ...
                {
                  id: 4,
                  display_name: "One record rule",
                  limited_to_single_record: true,
                },
              ],
            },
          });
      ...
      function () {
        QUnit.test("kanban basic rendering", async function (assert) {
          ...
          assert.strictEqual(
            kanban.$("header.active > label > span").text().trim(),
            "Workspace1",
            "the first selected record should be the first folder"
          );
          assert.strictEqual(
            kanban.$("header.active > span").text().trim(),
            "5",
          ...
          await testUtils.dom.click(
            kanban.$(".o_search_panel_category_value header:eq(0)")
          );

          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_upload").is(":disabled"),
            "the upload button should be disabled on global view"
          );
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_url").is(":disabled"),
            "the upload url button should be disabled on global view"
          );
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_request").is(":disabled"),
            "the request button should be disabled on global view"
          );
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_share_domain").is(":disabled"),
          ...
          await testUtils.dom.click(
            kanban.$(".o_search_panel_category_value header:eq(1)")
          );

          // Check view layout
          assert.containsN(kanban, ".o_content > div", 3, "should have 3 columns");
          assert.containsOnce(
            kanban.$(".o_content"),
            "> div.o_search_panel",
          ...
          assert.strictEqual(
            kanban.$(".o_cp_buttons .btn-primary").text().trim(),
            "Upload",
            "should have a primary 'Upload' button"
          );
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_upload").not(":disabled"),
          ...
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_url").not(":disabled"),
            "the upload url button should be enabled when a folder is selected"
          );
          assert.strictEqual(
            kanban.$(".o_cp_buttons button.o_documents_kanban_request").text().trim(),
            "Request",
            "should have a primary 'request' button"
          );
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_request").not(":disabled"),
          ...
          assert.ok(
            kanban.$buttons.find(".o_documents_kanban_share_domain").not(":disabled"),
        ...
        QUnit.test("can select records by clicking on the select icon", async function (
          assert
        ) {
          assert.expect(6);
        ...
        QUnit.test("can select records with keyboard navigation", async function (
          assert
        ) {
          assert.expect(4);
        ...
        QUnit.test("can multi select records with shift and ctrl", async function (
          assert
        ) {
          assert.expect(6);
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(yop) .o_record_selector")
            );
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(burp) .o_record_selector")
            );
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(blip) .o_record_selector")
            );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            var kanban = await createDocumentsView({
              ...
              mockRPC: function (route, args) {
                if (args.method === "read" && args.model === "documents.document") {
                  assert.deepEqual(args.args[0], [1], "should read the clicked record");
                }
            ...
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(yop) button")
            );
            ...
            assert.strictEqual(
              kanban.$(".o_record_selected:contains(yop changed)").length,
              1,
        ...
        QUnit.test("can share current domain", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$buttons.find(".o_documents_kanban_share_domain")
          );
        ...
        QUnit.test("can upload from URL", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$buttons.find("button.o_documents_kanban_url")
          );
        ...
        QUnit.test("can Request a file", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$buttons.find("button.o_documents_kanban_request")
          );
        ...
        QUnit.test("document inspector with no document selected", async function (
          assert
        ) {
          assert.expect(3);
          ...
          assert.strictEqual(
            kanban.$(".o_documents_inspector_preview").text().replace(/\s+/g, ""),
            "_F1-test-description_",
            "should display the current workspace description"
          );
          assert.strictEqual(
            kanban
              .$(".o_documents_inspector_info .o_inspector_value:first")
              .text()
              .trim(),
            "5",
          ...
          assert.strictEqual(
            kanban
              .$(".o_documents_inspector_info .o_inspector_value:nth(1)")
              .text()
              .trim(),
            "0.12 MB",
        ...
        QUnit.test("document inspector with selected documents", async function (
          assert
        ) {
          assert.expect(5);
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:first .o_record_selector")
          );
          ...
          assert.hasClass(
            kanban.$(".o_documents_inspector_preview .o_document_preview"),
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(2) .o_record_selector")
          );
          ...
          assert.strictEqual(
            kanban.$(".o_documents_inspector_preview .o_selection_size").text().trim(),
        ...
        QUnit.test("document inspector limits preview to 4 documents", async function (
          assert
        ) {
          assert.expect(2);
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(0) .o_record_selector")
          );
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(1) .o_record_selector")
          );
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(2) .o_record_selector")
          );
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(3) .o_record_selector")
          );
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:nth(4) .o_record_selector")
          );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            var kanban = await createDocumentsView({
              ...
              data: this.data,
              arch:
                '<kanban limit="2"><templates><t t-name="kanban-box">' +
                "<div>" +
                '<field name="name"/>' +
                "</div>" +
                "</t></templates></kanban>",
        ...
        QUnit.test("document inspector: document preview", async function (assert) {
          ...
          var kanban = await createDocumentsView({
            ...
            mockRPC: function (route) {
              if (
                route ===
                "/web/static/lib/pdfjs/web/viewer.html?file=/web/content/2?model%3Ddocuments.document%26filename%3Dblip"
              ) {
          ...
          assert.containsOnce(kanban, ".o_close_btn", "should have a close button");
          ...
          assert.containsOnce(
            kanban,
            ".o_documents_split_pdf_area",
            "should have a pdf splitter"
          );
        ...
        QUnit.test("document inspector: can delete records", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:contains(wip) .o_record_selector")
          );
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:contains(zorro) .o_record_selector")
          );
          ...
          await testUtils.dom.click(
            kanban.$(".o_documents_inspector_info .o_inspector_delete")
          );
          await testUtils.nextTick();
        ...
        QUnit.test("document inspector: can archive records", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$(".o_documents_inspector_info .o_inspector_archive")
          );
          ...
          assert.containsNone(
            kanban,
            ".o_kanban_view .o_record_selected",
        ...
        QUnit.test("document inspector: can share records", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$(".o_documents_inspector_info .o_inspector_share")
          );
        ...
        QUnit.test("document inspector: locked records", async function (assert) {
          ...
          assert.hasClass(
            kanban.$(".o_inspector_lock"),
            "o_locked",
            "this attachment should be locked"
          );
          assert.notOk(
            kanban.$(".o_inspector_lock").is(":disabled"),
            "lock button should not be disabled"
          );
          assert.notOk(
            kanban.$(".o_inspector_replace").is(":disabled"),
          ...
          assert.ok(
            kanban.$(".o_inspector_archive").is(":disabled"),
          ...
          var kanban = await createDocumentsView({
            ...
            mockRPC: function (route, args) {
              if (args.method === "toggle_lock") {
                ...
                var record = self.data["documents.document"].records.find(
                  (d) => d.id === 1
                );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.strictEqual(
              kanban.$(".o_field_widget[name=name]").val(),
              "yop",
              "should correctly display the name"
            );
            assert.strictEqual(
              kanban.$(".o_field_widget[name=owner_id] input").val(),
              "Hazard",
              "should correctly display the owner"
            );
            assert.strictEqual(
              kanban.$(".o_field_widget[name=partner_id] input").val(),
              "Lukaku",
            ...
            assert.strictEqual(
              kanban.$(".o_inspector_model_name").text(),
              " Task",
              "should correctly display the resource model"
            );
            assert.strictEqual(
              kanban.$(".o_inspector_object_name").text(),
              "Write specs",
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            // Change m2o value
            await testUtils.fields.many2one.searchAndClickItem("owner_id", {
              search: "De Bruyne",
            });
            await testUtils.nextTick();
            ...
            assert.strictEqual(
              kanban.$(".o_field_many2one[name=owner_id] input").val(),
              "De Bruyne",
              "should display the new value in the many2one"
            );

            kanban
              .$(".o_field_many2one[name=owner_id] input")
              .val("")
              .trigger("keyup")
              .trigger("focusout");
            await testUtils.nextTick();
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.strictEqual(
              kanban.$(".o_kanban_record:first").text(),
              "yop",
            ...
            assert.strictEqual(
              kanban.$(".o_field_char[name=name]").val(),
              "new name",
        ...
        QUnit.test("document inspector: open resource", async function (assert) {
          ...
          await testUtils.dom.click(
            kanban.$(".o_documents_inspector .o_inspector_object_name")
          );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            await testUtils.dom.click(
              kanban.$(".o_search_panel_category_value:eq(1) header")
            );
            await testUtils.dom.click(kanban.$(".o_kanban_record:first"));
            ...
            assert.strictEqual(
              kanban.$(".o_inspector_tag").text().replace(/\s/g, ""),
              "Status>Draft×",
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.containsN(kanban, ".o_inspector_tag", 3, "should have 3 tags");
            assert.containsNone(
              kanban,
        ...
        QUnit.test("document inspector: remove tag", async function (assert) {
          ...
          assert.containsN(kanban, ".o_inspector_tag", 2, "should display two tags");

          await testUtils.dom.click(
            kanban.$(".o_inspector_tag:first .o_inspector_tag_remove")
          );

          assert.containsOnce(kanban, ".o_inspector_tag", "should display one tag");
        ...
        QUnit.test("document inspector: unknown tags are hidden", async function (
          assert
        ) {
          assert.expect(1);
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.strictEqual(
              kanban.$(".o_inspector_rule").text().trim(),
              "Convincing AI not to turn evil",
              "should correctly display the content of the rule"
            );
            assert.hasAttrValue(
              kanban.$(".o_inspector_rule span"),
              "title",
        ...
        QUnit.test("document inspector: locked by another user", async function (
          assert
        ) {
          assert.expect(4);
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:contains(lockedByAnother)")
          );
          ...
          assert.containsNone(
            kanban,
            ".o_inspector_rule",
            "should not display any rule"
          );

          assert.ok(
            kanban.$(".o_inspector_lock").prop("disabled"),
            "the lock button should be disabled"
          );
          assert.ok(
            kanban.$(".o_inspector_replace").prop("disabled"),
            "the replace button should be disabled"
          );
          assert.ok(
            kanban.$(".o_inspector_archive").prop("disabled"),
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.strictEqual(
              kanban.$(".o_inspector_rule span:eq(0)").text(),
              "Convincing AI not to turn evil",
              "should display the right rule"
            );

            assert.strictEqual(
              kanban.$(".o_inspector_rule span:eq(1)").text(),
              "Follow the white rabbit",
              "should display the right rule"
            );

            assert.strictEqual(
              kanban.$(".o_inspector_rule span:eq(2)").text(),
              "One record rule",
              "should display the right rule"
            );
            ...
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(yop changed)")
            );
            await testUtils.dom.click(
              kanban.$(".o_kanban_record:contains(yop changed)")
            );
            ...
            assert.strictEqual(
              kanban.$(".o_inspector_rule span").text(),
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            await testUtils.dom.click(
              kanban.$(".o_inspector_rule .o_inspector_trigger_rule")
            );
            ...
            var kanban = await createDocumentsView({
              ...
              mockRPC: function (route, args) {
                if (args.method === "check_access_rights") {
                  ...
                  this.data["documents.document"].records = this.data[
                    "documents.document"
                  ].records.map((r) => {
                    if (r.id === args.args[0]) {
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            await testUtils.fields.editInput(
              kanban.$(".o_field_widget[name=partner_id] input"),
              "Dupont"
            );
            assert.strictEqual(
              $(".ui-autocomplete .o_m2o_dropdown_option").length,
              1,
        ...
        QUnit.test("document chatter: open and close chatter", async function (assert) {
          ...
          assert.containsNone(kanban, ".o_Chatter", "should not display any chatter");
          ...
          // Open the chatter
          await testUtils.dom.click(
            kanban.$(".o_documents_inspector .o_inspector_open_chatter")
          );

          assert.containsOnce(kanban, ".o_Chatter", "should display the chatter");
          assert.containsOnce(
            kanban,
            ".o_search_panel:visible",
            "documents selector should still be visible"
          );
          assert.containsOnce(
            kanban,
            ".o_kanban_view:visible",
            "kanban view should still be visible"
          );
          assert.containsOnce(
            kanban,
            ".o_documents_inspector:visible",
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.containsN(
              kanban,
              ".o_document_chatter_container .o_Chatter .o_Message",
              2,
        ...
        QUnit.test("document chatter: fetch and display followers", async function (
          assert
        ) {
          assert.expect(3);
          ...
          assert.strictEqual(
            document.querySelector(".o_FollowerListMenu_buttonFollowersCount")
              .textContent,
            "2",
        ...
        QUnit.test("document chatter: render the activity button", async function (
          assert
        ) {
          assert.expect(3);
          ...
          var $activityButton = kanban.$(
            ".o_document_chatter_container .o_ChatterTopbar_buttonScheduleActivity"
          );
          assert.strictEqual(
        ...
        QUnit.test("document chatter: render the activity button 2", async function (
          assert
        ) {
          assert.expect(8);
          ...
          assert.containsOnce(kanban, ".o_Activity", "should display an activity");
          assert.strictEqual(
            kanban.$(".o_Activity_markDoneButton").length,
            1,
          ...
          assert.containsNone(kanban, ".o_Activity", "should not display an activity");
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.containsNone(
              kanban,
              ".o_document_chatter_container .o_Composer",
            ...
            await testUtils.dom.click(
              kanban.$(
                ".o_document_chatter_container .o_ChatterTopbar_buttonSendMessage"
              )
            );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.containsOnce(
              kanban,
              ".o_document_chatter_container .o_Message",
              "should display one message in the chatter"
            );
            assert.strictEqual(
              kanban.$(".o_Message .o_Message_content").text().trim(),
              "Message on 'yop'",
        ...
        QUnit.test("document selector: basic rendering", async function (assert) {
          ...
          assert.strictEqual(
            kanban
              .$(
                ".o_search_panel .o_search_panel_filter_group:first label:first > span"
              )
              .text()
              .replace(/\s/g, ""),
            "●Priority",
          ...
          assert.strictEqual(
            kanban
              .$(".o_search_panel .o_search_panel_filter_group:first label:first")
              .attr("title")
              .trim(),
            "A priority tooltip",
          ...
          assert.strictEqual(
            kanban
              .$(".o_search_panel .o_search_panel_filter_group:last label:first > span")
              .text()
              .replace(/\s/g, ""),
            "●Status",
          ...
          assert.strictEqual(
            kanban
              .$(".o_search_panel .o_search_panel_filter_group:last label:first")
              .attr("title")
              .trim(),
            "A Status tooltip",
            "the last facet should be 'Status'"
          ...
          assert.containsN(
            kanban,
            ".o_search_panel .o_search_panel_filter_group:last .o_search_panel_filter_value",
            2,
          ...
          assert.strictEqual(
            kanban
              .$(
                ".o_search_panel .o_search_panel_filter_group:last .o_search_panel_filter_value:first label"
              )
              .text()
              .trim(),
            "Draft",
          ...
          assert.strictEqual(
            kanban
              .$(
                ".o_search_panel .o_search_panel_filter_group:last .o_search_panel_filter_value:last label"
              )
              .text()
              .trim(),
            "New",
          ...
          assert.strictEqual(
            kanban
              .$(
                ".o_search_panel .o_search_panel_section:nth-child(3) .o_search_panel_section_header"
              )
              .text()
              .trim(),
            "Attached To",
          ...
          assert.containsN(
            kanban,
            ".o_search_panel .o_search_panel_section:nth-child(3) .o_search_panel_filter_value",
            4,
        ...
        QUnit.test("document selector: render without facets & tags", async function (
          assert
        ) {
          assert.expect(3);
        ...
        QUnit.test("document selector: render without related models", async function (
          assert
        ) {
          assert.expect(4);
          ...
          assert.containsNone(
            kanban,
            '.o_search_panel .o_search_panel_section:nth-child(3) .o_search_panel_filter_value:contains("Not attached")',
            "should not have an unattached document"
          );
          assert.containsOnce(
            kanban,
            '.o_search_panel .o_search_panel_section:nth-child(3) .o_search_panel_filter_value:contains("Not a file")',
            "should at least have a no-model element"
          );
        ...
        QUnit.test("document selector: filter on related model", async function (
          assert
        ) {
          assert.expect(8);
          ...
          assert.containsN(
            kanban,
            ".o_search_panel .o_search_panel_section:nth-child(2) .o_search_panel_filter_value",
            4,
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            assert.strictEqual(
              kanban.$(".o_kanban_view .o_kanban_record:not(.o_kanban_ghost)").length,
              2,
              "should have 3 records in the renderer"
            );
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            await testUtils.dom.click(
              kanban.$(".o_search_panel_filter_value:contains(Draft) input")
            );
            ...
            await testUtils.dom.click(
              kanban.$(".o_search_panel_category_value:contains(Workspace2) header")
            );
        ...
        QUnit.test("documents Kanban color widget", async function (assert) {
          ...
          assert.containsN(
            kanban,
            ".o_field_many2manytags:nth(2) > span",
            3,
            "All the records should have 3 tags"
          );

          assert.containsOnce(
            kanban.$(".o_field_many2manytags:nth(2) > span:first"),
            "> span",
            "should have a span for color ball"
          );

          assert.strictEqual(
            kanban.$(".o_field_many2manytags:nth(2) > span:first > span").css("color"),
            "rgb(240, 96, 80)",
        ...
        QUnit.test("kanban color widget without SearchPanel", async function (assert) {
          ...
          assert.containsN(
            kanban.$(".o_field_many2manytags:nth(2)"),
            ".o_tag_color_0",
            3,
        ...
        QUnit.test(
          ...
          async function (assert) {
            ...
            kanban
              .$(".o_search_panel_category_value header:eq(2)")[0]
        ...
        QUnit.test("documents: upload replace bars", async function (assert) {
          ...
          const ORIGINAL_PROMPT_FILE_INPUT =
            DocumentsKanbanController.prototype._promptFileInput;
          DocumentsKanbanController.prototype._promptFileInput = ($input) =>
            testUtils.file.inputFiles($input[0], [file]);
          ...
          assert.containsOnce(
            kanban,
            ".o_documents_attachment > .o_file_upload_progress_bar",
            "there should be a progress card"
          );
          assert.containsOnce(
            kanban,
            ".o_documents_attachment > .o_file_upload_progress_bar > .o_file_upload_progress_bar_value",
            "there should be a progress bar"
          );
          assert.containsOnce(
            kanban,
            ".o_documents_attachment > .o_file_upload_progress_bar > .o_upload_cross",
        ...
        QUnit.test("documents: upload multiple progress bars", async function (assert) {
          ...
          assert.verifySteps(["xhrSend"]);
          assert.strictEqual(
            kanban.$(".o_kanban_record_title > span:eq(0)").text(),
            "text1.txt",
        ...
        QUnit.test("documents Kanban: displays youtube thumbnails", async function (
          assert
        ) {
          assert.expect(1);
          ...
          await testUtils.dom.click(
            kanban.$(".o_kanban_record:contains(youtubeVideo) .o_record_selector")
          );
        ...
        QUnit.test("documents List: multi selection", async function (assert) {
          ...
          assert.ok(
            $record.find(".o_list_record_selector input").prop("checked"),
            "the record should be selected"
          );

          list.$('.o_document_list_record[data-res-id="5"]').trigger(
            $.Event("click", {
              shiftKey: true,
            })
          );
        ...
        QUnit.test("documents List: selection using keyboard", async function (assert) {
          ...
          let $recordSelector = list.$(
            '.o_document_list_record[data-res-id="5"] .o_list_record_selector'
          );
          $recordSelector.focus().trigger(
            $.Event("keydown", {
              keyCode: $.ui.keyCode.ENTER,
              which: $.ui.keyCode.ENTER,
            })
          ...
          assert.ok(
            $recordSelector.find("input").prop("checked"),
            "the right record should be selected"
          );

          $recordSelector = list.$(
            '.o_document_list_record[data-res-id="4"] .o_list_record_selector'
          );
          $recordSelector.focus().trigger(
            $.Event("keydown", {
              keyCode: $.ui.keyCode.ENTER,
          ...
          list
            .$('.o_document_list_record[data-res-id="3"] td:first')
            .focus()
            .trigger(
              $.Event("keydown", {
                keyCode: $.ui.keyCode.ENTER,
          ...
          list
            .$('.o_document_list_record[data-res-id="2"] .o_list_record_selector')
            .focus()
            .trigger(
              $.Event("keydown", {
        ...
        QUnit.test("documents List: listview is not groupable", async function (
          assert
        ) {
          assert.expect(1);
        ...
        QUnit.test("documents: Versioning", async function (assert) {
          ...
          assert.strictEqual(
            kanban.$(".o_inspector_history_name").text(),
            "oldYoutubeVideo",
            "should display the correct record name"
          );
          assert.strictEqual(
            kanban.$(".o_inspector_history_create_name").text(),
            "Lukaku",
        ...
        QUnit.test("store and retrieve active category value", async function (assert) {
          ...
          expectedActiveId = 2;
          await testUtils.dom.click(
            kanban.$(".o_search_panel_category_value:nth(3) header")
          );
