...
class WebsiteSale(main.WebsiteSale):
    ...
    @http.route(
        "/shop/property_ups_carrier_account/set",
        type="http",
        auth="public",
        website=True,
        sitemap=False,
    ...
    def set_property_ups_carrier_account(self, **post):
        ...
        if order.carrier_id.ups_bill_my_account and post.get(
    ...
    @http.route(
        "/shop/property_ups_carrier_account/unset",
        type="http",
        auth="public",
        website=True,
        sitemap=False,
...
class CustomerPortal(portal.CustomerPortal):
    OPTIONAL_BILLING_FIELDS = [
        *portal.CustomerPortal.OPTIONAL_BILLING_FIELDS,
        "property_ups_carrier_account",
    ]
