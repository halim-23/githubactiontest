...
class AccountConsolidationTestCase(common.TransactionCase):
    def setUp(self):
        ...
        self.us_company = self.env["res.company"].create(
            {"name": "Vincent Company", "currency_id": 2}
        )
    ...
    def _create_consolidation_account(
        self, name="BLAH", currency_mode="end", chart=None, section=None
    ):
    ...
    def _create_analysis_period(
        self, start_date="2019-01-01", end_date="2019-12-31", chart=None
    ):
    ...
    def _create_company_period(
        ...
        period = period or self._create_analysis_period(
    ...
    def _create_basic_move(
        ...
        account_credit = account_credit or self._create_account(
            "XX1", "Credit account", company=company
        )
        account_debit = account_debit or self._create_account(
            "XX2", "Debit account", company=company
        )
