...
class TestCodaFile(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref="l10n_be.l10nbe_chart_template"):
        ...
        coda_file_path = get_module_resource(
            "l10n_be_coda", "test_coda_file", "Ontvangen_CODA.2013-01-11-18.59.15.txt"
        )
    ...
    def test_coda_file_import(self):
        self.env["account.bank.statement.import"].with_context(
            ...
            {"attachment_ids": [(0, 0, {"name": "test file", "datas": self.coda_file})]}
        ).import_file()
    ...
    def test_coda_file_import_twice(self):
        ...
        with self.assertRaises(Exception):
            self.env["account.bank.statement.import"].with_context(
                ...
                {
                    "attachment_ids": [
                        (0, 0, {"name": "test file", "datas": self.coda_file})
                    ]
                }
            ).import_file()
