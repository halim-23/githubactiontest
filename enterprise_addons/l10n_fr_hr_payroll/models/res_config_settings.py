...
class ResConfigSettings(models.TransientModel):
    ...
    plafond_secu = fields.Float(
        related="company_id.plafond_secu",
        string="Plafond de la Securite Sociale",
        readonly=False,
    )
    nombre_employes = fields.Integer(
        related="company_id.nombre_employes", string="Nombre d'employes", readonly=False
    )
    ...
    conv_coll = fields.Char(
        related="company_id.conv_coll", string="Convention collective", readonly=False
    )
