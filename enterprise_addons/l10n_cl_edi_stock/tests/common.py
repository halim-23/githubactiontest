...
class TestL10nClEdiStockCommon(TestStockCommon):
    ...
    def setUpClass(cls):
            ...
            .create(
                {
                    ...
                    "private_key": misc.file_open(
                        "l10n_cl_edi_stock/tests/private_key_test.key"
                    ).read(),
                    "certificate": misc.file_open(
                        "l10n_cl_edi_stock/tests/cert_test.cert"
                    ).read(),
        ...
        cls.company.write({"l10n_cl_certificate_ids": [(4, cls.certificate.id)]})
        ...
        caf_file_template = misc.file_open(
            "l10n_cl_edi_stock/tests/template/caf_file_template.xml"
        ).read()
