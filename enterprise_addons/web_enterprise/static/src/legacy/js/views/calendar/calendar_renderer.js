odoo.define("web_enterprise.CalendarRenderer", function (require) {
  ...
  CalendarRenderer.include({
    ...
    _onPopoverShown: function ($popoverElement, calendarPopover) {
      ...
      setTimeout(() => {
        $popover.toggleClass(["bs-popover-left", "bs-popover-right"], false);
        ...
        $popover
          .find(".o_cw_popover_fields_secondary")
        ...
        $popover.find("a.o_field_widget[href]").on("click", (event) => {
    ...
    _renderFilters: function () {
      return this._super(...arguments).then(() => {
        ...
        const reduce = Boolean(this.filtersMobile.reduce(
          (visible, filter) => visible | (filter.countItems > 0),
          false
        ));
    ...
    _renderOtherCalendar: function () {
      ...
      this.otherCalendarMobile = $(
        qweb.render("CalendarView.OtherCalendarMobile", {
    ...
    _toggleSidePanel: async function () {
      ...
      this.$(".o_calendar_sidebar_container").toggleClass(
        "d-none",
        !this.isSidePanelVisible
      );
      this._renderOtherCalendar();
    },
    /**
