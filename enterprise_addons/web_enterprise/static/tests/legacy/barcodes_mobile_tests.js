odoo.define("web_mobile.barcode.tests", function (require) {
  ...
  QUnit.module(
    ...
    function () {
      QUnit.test(
        "web_mobile: barcode button in a mobile environment with single results",
        async function (assert) {
          ...
          assert.equal(
            selectedId,
            this.data[PRODUCT_PRODUCT].records[0].id,
      ...
      QUnit.test(
        "web_mobile: barcode button in a mobile environment with multiple results",
        async function (assert) {
          assert.expect(4);
          ...
          assert.equal(
            selectedId,
            this.data[PRODUCT_PRODUCT].records[1].id,
