...
class AccountTax(models.Model):
    ...
    l10n_pe_edi_affectation_reason = fields.Selection(
        ...
        store=True,
        readonly=False,
        compute="_compute_l10n_pe_edi_affectation_reason",
    ...
    def _compute_l10n_pe_edi_affectation_reason(self):
        ...
        for tax in self:
            tax.l10n_pe_edi_affectation_reason = tax_comparison.get(
                tax.l10n_pe_edi_tax_code, False
            )
    ...
    def _compute_l10n_pe_edi_international_code(self):
        ...
        for tax in self:
            tax.l10n_pe_edi_international_code = international_codes_mapping.get(
                tax.l10n_pe_edi_tax_code, "VAT"
            )
