...
class AccountMoveLine(models.Model):
    ...
    def _compute_l10n_pe_edi_affectation_reason(self):
        ...
        """
        for line in self:
            taxes_with_code = line.tax_ids.filtered(
                lambda tax: tax.l10n_pe_edi_tax_code
            )
            if line.exclude_from_invoice_tab or not taxes_with_code:
                line.l10n_pe_edi_affectation_reason = False
            else:
                line.l10n_pe_edi_affectation_reason = taxes_with_code[
                    0
                ].l10n_pe_edi_affectation_reason
