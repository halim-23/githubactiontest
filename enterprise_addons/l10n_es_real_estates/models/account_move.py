...
class AccountMove(models.Model):
    ...
    l10n_es_real_estate_id = fields.Many2one(
        string="Real Estate",
        comodel_name="l10n_es_reports.real.estate",
        help="Real estate related to this invoice, in case we are leasing it.",
    )
    l10n_es_reports_mod347_invoice_type = fields.Selection(
        selection_add=[("real_estates", "Real estates operation")]
    )
...
class AccountMoveLine(models.Model):
    ...
    l10n_es_real_estate_id = fields.Many2one(
        string="Real Estate",
        related="move_id.l10n_es_real_estate_id",
        store=True,
        help="Real estate related to the invoice that created this move line, in case we are leasing it.",
        readonly=False,
    )
