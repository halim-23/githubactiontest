...
class OSSTaxReportTest(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.init_invoice(
            "out_invoice",
            partner=cls.partner_be,
            products=cls.product_1,
            invoice_date=fields.Date.from_string("2021-04-01"),
            post=True,
        )
        cls.init_invoice(
            "out_invoice",
            partner=cls.partner_fr,
            products=cls.product_1,
            invoice_date=fields.Date.from_string("2021-05-23"),
            post=True,
        )
        cls.init_invoice(
            "out_invoice",
            partner=cls.partner_lu,
            products=cls.product_1,
            invoice_date=fields.Date.from_string("2021-06-12"),
            post=True,
        )
