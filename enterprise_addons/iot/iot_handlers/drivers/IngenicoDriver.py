...
from odoo.addons.hw_drivers.iot_handlers.interfaces.SocketInterface import (
    socket_devices,
)
    ...
    def getTransactionTicket(self):
        ...
        if "Group_TicketData" in self._tagTree["msg"]["Group_Body"]:
            ...
            ticket_bodies = [
                ...
                if "TicketBody" in r and r["TicketBody"]
            ]
            return b"\n".join(ticket_bodies)
        return False
        ...
        try:
            ...
            while not self._stopped.isSet():
                ...
                if msg and msg.magic == b"P4Y-ECR!":
                    ...
                    self.data["Stage"] = (
                        msg.getTransactionStage()
                        if msg.getTransactionStage()
                        else self.data["Stage"]
                    )
