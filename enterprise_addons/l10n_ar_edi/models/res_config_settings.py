...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_ar_afip_verification_type = fields.Selection(
        related="company_id.l10n_ar_afip_verification_type", readonly=False
    )

    l10n_ar_afip_ws_environment = fields.Selection(
        related="company_id.l10n_ar_afip_ws_environment", readonly=False
    )
    l10n_ar_afip_ws_key = fields.Binary(
        related="company_id.l10n_ar_afip_ws_key", readonly=False
    )
    l10n_ar_afip_ws_crt = fields.Binary(
        related="company_id.l10n_ar_afip_ws_crt", readonly=False
    )

    l10n_ar_afip_ws_key_fname = fields.Char(
        "Private Key name", default="private_key.pem"
    )
    l10n_ar_afip_ws_crt_fname = fields.Char(
        related="company_id.l10n_ar_afip_ws_crt_fname"
    )

    l10n_ar_fce_transmission_type = fields.Selection(
        related="company_id.l10n_ar_fce_transmission_type", readonly=False
    )
    ...
    def l10n_ar_action_create_certificate_request(self):
        ...
        return {
            ...
            "url": "/l10n_ar_edi/download_csr/" + str(self.company_id.id),
            "target": "new",
        }
