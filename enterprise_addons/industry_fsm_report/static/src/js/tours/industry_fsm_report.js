odoo.define("industry_fsm_report.tour", function (require) {
  ...
  tour.tours.industry_fsm_tour.steps.splice(
    ...
    },
    {
      ...
      content: Markup(
        _t(
          "Save your <b>worksheet</b> once it is complete.<br/><i>Tip: customize this form to your needs and create as many templates as you want.</i>"
        )
      ),
  ...
  var fsmSaveTimesheetStepIndex = _.findIndex(
