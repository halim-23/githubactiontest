...
class HrEmployee(models.Model):
    ...
    registration_number = fields.Char(
        "Registration Number of the Employee", groups="hr.group_hr_user", copy=False
    )
    ...
    mobile_invoice = fields.Binary(
        string="Mobile Subscription Invoice",
        groups="hr_contract.group_hr_contract_manager",
    )
    sim_card = fields.Binary(
        string="SIM Card Copy", groups="hr_contract.group_hr_contract_manager"
    )
    internet_invoice = fields.Binary(
