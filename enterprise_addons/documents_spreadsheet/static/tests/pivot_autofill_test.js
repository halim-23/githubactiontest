...
module("documents_spreadsheet > pivot_autofill", {}, () => {
  test("Autofill pivot values", async function (assert) {
    ...
    assert.strictEqual(
      getAutofillValue(model, "C3", {direction: "bottom", steps: 3}),
      ""
    );
    assert.strictEqual(
      getAutofillValue(model, "C3", {direction: "right", steps: 4}),
      ""
    );
    ...
    assert.strictEqual(
      getAutofillValue(model, "A4", {direction: "bottom", steps: 2}),
      ""
    );
    ...
    assert.strictEqual(
      getAutofillValue(model, "B2", {direction: "bottom", steps: 4}),
      ""
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      getAutofillValue(model, "A3", {direction: "right", steps: 6}),
      ""
    );
  ...
  test("Autofill pivot values with date in rows", async function (assert) {
    ...
    assert.strictEqual(getAutofillValue(model, "F6", {direction: "top", steps: 1}), "");
  });
  ...
  test("Tooltip of pivot formulas with 2 measures", async function (assert) {
    ...
    assert.deepEqual(
      model.getters.getTooltipFormula(getCellFormula(model, "C3"), true),
      [
        {
          title: "name",
          value: "(Undefined)",
