...
QUnit.module("documents_spreadsheet > list_autofill", {}, () => {
  QUnit.test("Autofill list values", async function (assert) {
    ...
    assert.strictEqual(
      getListAutofillValue(model, "C3", {direction: "right", steps: 4}),
      ""
    );
    ...
    assert.strictEqual(
      getListAutofillValue(model, "A4", {direction: "top", steps: 4}),
      ""
    );
    ...
    assert.strictEqual(
      getListAutofillValue(model, "A3", {direction: "right", steps: 6}),
      ""
    );
  });
