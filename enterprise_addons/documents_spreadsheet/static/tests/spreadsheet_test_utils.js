...
export async function createSpreadsheetAction(actionTag, params = {}) {
  ...
  const SpreadsheetActionComponent =
    actionTag === "action_open_spreadsheet"
      ? SpreadsheetAction
      : SpreadsheetTemplateAction;
  ...
  const transportService =
    params.transportService || new MockSpreadsheetCollaborativeChannel();
