...
class TestTimesheet(TestHelpdeskTimesheetCommon):
    ...
    def test_compute_timesheet_partner_from_ticket_customer(self):
        ...
        self.assertEqual(
            ...
            self.partner,
            "The timesheet entry's partner should be equal to the ticket's partner/customer",
        )
        ...
        self.assertEqual(
            timesheet_entry.partner_id,
            partner2,
            "The timesheet entry's partner should still be equal to the ticket's partner/customer, after the change",
        )
