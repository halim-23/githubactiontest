  ...
  tour.register(
    ...
    [
      {
        ...
        content: Markup(
          _t(
            "Want to <b>boost your customer satisfaction</b>?<br/><i>Click Helpdesk to start.</i>"
          )
        ),
        position: "bottom",
      },
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "Enter the <b>subject</b> of your ticket <br/><i>(e.g. Problem with my installation, Wrong order, etc.).</i>"
          )
        ),
        position: "right",
      },
    ...
    or <b># mentions</b> to contact a group of people."
      ...
      },
      {
        ...
        extra_trigger: ".o_form_view.o_form_readonly",
        content: _t(
          "Let's go back to the <b>kanban view</b> to have an overview of your next tickets."
        ),
        position: "bottom",
      },
      {
        ...
        content: Markup(
          _t("<b>Drag &amp; drop</b> the card to change the stage of your ticket.")
        ),
        position: "right",
      ...
      },
      {
        ...
        content: Markup(
          _t(
            "Adapt your <b>pipeline</b> to your workflow by adding <b>stages</b> <i>(e.g. Awaiting Customer Feedback, etc.).</i>"
          )
        ),
        position: "right",
      },
